-- ==========================================
-- Delete Duplicate "Atlas Sync" Agent Entry (Customized from Template)
-- Created: 2026-04-23
...
-- Template: scripts/database-templates/_delete-agent-template.sql
-- ==========================================
...
-- 10. Clear activity_log agent_id FK (nullable)
UPDATE activity_log 
SET agent_id = NULL 
WHERE agent_id::TEXT IN (SELECT id FROM to_delete);

-- 11. Delete activity log entries where agent is the actor (nullable FK)
...
-- ==========================================
-- NOTES:
-- - This script follows the actual schema from packages/db/src/schema/
-- - execution_workspaces does NOT have agent_id FK (removed from script)
...
-- - Customized from template: scripts/database-templates/_delete-agent-template.sql
-- ==========================================
