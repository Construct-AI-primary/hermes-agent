-- ============================================================
-- MeasureForge AI Agent Restoration Script
-- Created: 2026-04-22
-- Description: Restores the 21 correct MeasureForge AI agents
--              after incorrect mass deletion
-- Prerequisites: Company exists, backup tables available if needed
-- ============================================================
...
-- SELECT COUNT(*) as restored_agents FROM agents WHERE company_id = '2B5D3695-102D-4C02-8785-D53B306E29BF';
