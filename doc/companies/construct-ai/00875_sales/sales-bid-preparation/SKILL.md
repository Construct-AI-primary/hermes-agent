---
title: Sales Sales Bid Preparation
description: Bid/proposal preparation workflow
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00875_sales/sales-bid-preparation
gigabrain_tags: disciplines, 00875_sales, sales-bid-preparation, sales
openstinger_context: sales, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/00875_sales/agent-data/domain-knowledge/00875_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/00875_sales/agent-data/prompts/00875_AI-NATIVE-SALES-PROMPT.md
---

# Sales Sales Bid Preparation

## Overview
Bid/proposal preparation workflow
**Announce at start:** "I'm using the sales-bid-preparation skill for Sales operations."

## When to Use This Skill
**Trigger Conditions:** Bid/proposal preparation workflow task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the sales task or request
...
### Step 3: Execution
1. Apply discipline-specific sales bid preparation methods
...
3. Update sales records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Sales Bid Preparation output generated
...
### Related Agents
- Sales Coordinator — Primary agent
- Sales Manager — Oversight agent
