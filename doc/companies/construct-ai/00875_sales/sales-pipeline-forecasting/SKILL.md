...
description: Maintain sales pipeline, forecast revenue, track win/loss rates, report on metrics
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00875_sales/sales-pipeline-forecasting
gigabrain_tags: disciplines, 00875_sales, sales-pipeline-forecasting, sales
...
## Overview
Maintain sales pipeline, forecast revenue, track win/loss rates, report on metrics

**Announce at start:** "I'm using the sales-pipeline-forecasting skill for Sales operations."

## When to Use This Skill
**Trigger Conditions:** Maintain sales pipeline, forecast revenue, track win/loss rates, report on metrics task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for maintain sales pipeline, forecast revenue, track win/loss rates, report on metrics
...
- [ ] Sales Pipeline and Revenue Forecasting output generated per requirements
...
- [ ] Sales Pipeline and Revenue Forecasting completed successfully
