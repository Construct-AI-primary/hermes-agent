---
title: Sales Bid and Proposal Preparation
description: Prepare bid documents and proposals including executive summaries, methodology, pricing, and compliance matrices
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00875_sales/sales-bid-proposal-preparation
gigabrain_tags: disciplines, 00875_sales, sales-bid-proposal-preparation, sales
openstinger_context: 00875_sales_operations, skill-execution
...
## Overview
Prepare bid documents and proposals including executive summaries, methodology, pricing, and compliance matrices

**Announce at start:** "I'm using the sales-bid-proposal-preparation skill for Sales operations."

## When to Use This Skill
**Trigger Conditions:** Prepare bid documents and proposals including executive summaries, methodology, pricing, and compliance matrices task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Sales domain knowledge)
...
1. Identify the specific sales task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare bid documents and proposals including executive summaries, methodology, pricing, and compliance matrices
...
4. Update sales records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Sales Bid and Proposal Preparation output generated per requirements
...
- [ ] Sales Bid and Proposal Preparation completed successfully
...
### Related Skills
- Additional sales skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Bid Manager — Main execution
- **Supporting:** Sales Administrator — Document and data management
- **Oversight:** Sales Manager — Review, approval, and escalation

### Related Domain Knowledge
- Sales Domain Knowledge for role responsibilities and frameworks
- Sales Glossary for terminology, definitions, and abbreviations
