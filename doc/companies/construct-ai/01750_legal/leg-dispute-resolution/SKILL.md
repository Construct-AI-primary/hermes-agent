---
title: Legal Leg Dispute Resolution
description: Dispute resolution workflow management
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01750_legal/leg-dispute-resolution
gigabrain_tags: disciplines, 01750_legal, leg-dispute-resolution, legal
openstinger_context: legal, skill-execution
...
# Legal Leg Dispute Resolution

## Overview
Dispute resolution workflow management
**Announce at start:** "I'm using the leg-dispute-resolution skill for Legal operations."

## When to Use This Skill
**Trigger Conditions:** Dispute resolution workflow management task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the legal task or request
...
### Step 3: Execution
1. Apply discipline-specific leg dispute resolution methods
...
3. Update legal records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Leg Dispute Resolution output generated
...
### Related Agents
- Legal Coordinator — Primary agent
- Legal Manager — Oversight agent
