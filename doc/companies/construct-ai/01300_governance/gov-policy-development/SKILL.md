---
title: Governance Gov Policy Development
description: Policy development and review
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01300_governance/gov-policy-development
gigabrain_tags: disciplines, 01300_governance, gov-policy-development, governance
openstinger_context: governance, skill-execution
...
# Governance Gov Policy Development

## Overview
Policy development and review
**Announce at start:** "I'm using the gov-policy-development skill for Governance operations."

## When to Use This Skill
**Trigger Conditions:** Policy development and review task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the governance task or request
...
### Step 3: Execution
1. Apply discipline-specific gov policy development methods
...
- [ ] Gov Policy Development output generated
...
### Related Agents
- Governance Coordinator — Primary agent
- Governance Manager — Oversight agent
