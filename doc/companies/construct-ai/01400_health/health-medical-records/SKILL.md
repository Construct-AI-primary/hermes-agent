---
title: Health Health Medical Records
description: Medical records management
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01400_health/health-medical-records
gigabrain_tags: disciplines, 01400_health, health-medical-records, health
openstinger_context: health, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/01400_health/agent-data/domain-knowledge/01400_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/01400_health/agent-data/prompts/01400_AI-NATIVE-HEALTH-PROMPT.md
---
...
**Announce at start:** "I'm using the health-medical-records skill for Health operations."

## When to Use This Skill
**Trigger Conditions:** Medical records management task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the health task or request
...
### Step 3: Execution
1. Apply discipline-specific health medical records methods
...
- [ ] Health Medical Records output generated
...
## Cross-References
### Related Skills
- Additional health skills
### Related Agents
- Health Coordinator — Primary agent
- Health Manager — Oversight agent
