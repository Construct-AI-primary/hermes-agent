---
title: Health Medical Surveillance Program
description: Manage medical surveillance program, schedule assessments, track results, manage fitness certifications
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01400_health/health-medical-surveillance-program
gigabrain_tags: disciplines, 01400_health, health-medical-surveillance-program, health
openstinger_context: 01400_health_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/01400_health/agent-data/domain-knowledge/01400_DOMAIN-KNOWLEDGE.MD
---

# Health Medical Surveillance Program

## Overview
Manage medical surveillance program, schedule assessments, track results, manage fitness certifications

**Announce at start:** "I'm using the health-medical-surveillance-program skill for Health operations."

## When to Use This Skill
**Trigger Conditions:** Manage medical surveillance program, schedule assessments, track results, manage fitness certifications task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Health domain knowledge)
...
1. Identify the specific health task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage medical surveillance program, schedule assessments, track results, manage fitness certifications
...
4. Update health records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Health Medical Surveillance Program output generated per requirements
...
- [ ] Health Medical Surveillance Program completed successfully
...
### Related Skills
- Additional health skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Health Manager — Main execution
- **Supporting:** Health Administrator — Document and data management
- **Oversight:** Health Manager — Review, approval, and escalation

### Related Domain Knowledge
- Health Domain Knowledge for role responsibilities and frameworks
- Health Glossary for terminology, definitions, and abbreviations
