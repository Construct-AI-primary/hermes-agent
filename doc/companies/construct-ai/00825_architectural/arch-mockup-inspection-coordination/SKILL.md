---
title: Architectural Mockup Inspection Coordination
description: Coordinate architectural mockups, review submissions, document findings, approve mockups
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-mockup-inspection-coordination
gigabrain_tags: disciplines, 00825_architectural, arch-mockup-inspection-coordination, architectural
...
# Architectural Mockup Inspection Coordination

## Overview
Coordinate architectural mockups, review submissions, document findings, approve mockups

**Announce at start:** "I'm using the arch-mockup-inspection-coordination skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate architectural mockups, review submissions, document findings, approve mockups task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate architectural mockups, review submissions, document findings, approve mockups
...
- [ ] Architectural Mockup Inspection Coordination output generated per requirements
...
- [ ] Architectural Mockup Inspection Coordination completed successfully
...
### Related Agents
- **Primary:** Architectural Technician — Main execution
