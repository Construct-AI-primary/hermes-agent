---
title: Architectural BIM Coordination Management
description: Coordinate architectural BIM models with other disciplines, resolve clashes, update federated model
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-bim-coordination-management
gigabrain_tags: disciplines, 00825_architectural, arch-bim-coordination-management, architectural
openstinger_context: 00825_architectural_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00825_architectural/agent-data/domain-knowledge/00825_DOMAIN-KNOWLEDGE.MD
---

# Architectural BIM Coordination Management

## Overview
Coordinate architectural BIM models with other disciplines, resolve clashes, update federated model

**Announce at start:** "I'm using the arch-bim-coordination-management skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate architectural BIM models with other disciplines, resolve clashes, update federated model task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Architectural domain knowledge)
...
1. Identify the specific architectural task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate architectural bim models with other disciplines, resolve clashes, update federated model
...
4. Update architectural records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Architectural BIM Coordination Management output generated per requirements
...
- [ ] Architectural BIM Coordination Management completed successfully
...
### Related Skills
- Additional architectural skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Architectural Coordinator — Main execution
- **Supporting:** Architectural Administrator — Document and data management
- **Oversight:** Architectural Manager — Review, approval, and escalation

### Related Domain Knowledge
- Architectural Domain Knowledge for role responsibilities and frameworks
- Architectural Glossary for terminology, definitions, and abbreviations
