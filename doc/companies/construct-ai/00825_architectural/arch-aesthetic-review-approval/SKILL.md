---
title: Architectural Aesthetic Review and Approval
description: Review architectural elements for aesthetic compliance with design intent and client requirements
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-aesthetic-review-approval
gigabrain_tags: disciplines, 00825_architectural, arch-aesthetic-review-approval, architectural
...
# Architectural Aesthetic Review and Approval

## Overview
Review architectural elements for aesthetic compliance with design intent and client requirements

**Announce at start:** "I'm using the arch-aesthetic-review-approval skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** Review architectural elements for aesthetic compliance with design intent and client requirements task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for review architectural elements for aesthetic compliance with design intent and client requirements
...
- [ ] Architectural Aesthetic Review and Approval output generated per requirements
...
- [ ] Architectural Aesthetic Review and Approval completed successfully
...
### Related Agents
- **Primary:** Project Architect — Main execution
