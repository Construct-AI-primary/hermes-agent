---
title: Scheduling Master Schedule Development
description: Develop master project schedules, define activities, establish logic, calculate floats, set baselines
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02035_scheduling/sched-master-schedule-development
gigabrain_tags: disciplines, 02035_scheduling, sched-master-schedule-development, scheduling
...
# Scheduling Master Schedule Development

## Overview
Develop master project schedules, define activities, establish logic, calculate floats, set baselines

**Announce at start:** "I'm using the sched-master-schedule-development skill for Scheduling operations."

## When to Use This Skill
**Trigger Conditions:** Develop master project schedules, define activities, establish logic, calculate floats, set baselines task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for develop master project schedules, define activities, establish logic, calculate floats, set baselines
...
- [ ] Scheduling Master Schedule Development output generated per requirements
...
- [ ] Scheduling Master Schedule Development completed successfully
