...
description: Administer executed contracts including compliance monitoring, correspondence, and records management
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00435_contracts-post-award/post-award-contract-admin
gigabrain_tags: disciplines, 00435_contracts-post-award, post-award-contract-admin, contracts-post-award
...
## Overview
Administer executed contracts including compliance monitoring, correspondence, and records management

**Announce at start:** "I'm using the post-award-contract-admin skill for Contracts Post-Award operations."

## When to Use This Skill
**Trigger Conditions:** Administer executed contracts including compliance monitoring, correspondence, and records management task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for administer executed contracts including compliance monitoring, correspondence, and records management
...
- [ ] Post-Award Contract Administration output generated per requirements
...
- [ ] Post-Award Contract Administration completed successfully
