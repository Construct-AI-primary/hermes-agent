---
title: Post-Award Claims Management
description: Evaluate and administer claims received during contract execution including documentation and assessment
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00435_contracts-post-award/post-award-claims-management
gigabrain_tags: disciplines, 00435_contracts-post-award, post-award-claims-management, contracts-post-award
openstinger_context: 00435_contracts_post_award_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00435_contracts-post-award/agent-data/domain-knowledge/00435_DOMAIN-KNOWLEDGE.MD
---

# Post-Award Claims Management

## Overview
Evaluate and administer claims received during contract execution including documentation and assessment

**Announce at start:** "I'm using the post-award-claims-management skill for Contracts Post-Award operations."

## When to Use This Skill
**Trigger Conditions:** Evaluate and administer claims received during contract execution including documentation and assessment task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Contracts Post-Award domain knowledge)
...
1. Identify the specific contracts post-award task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for evaluate and administer claims received during contract execution including documentation and assessment
...
4. Update contracts post-award records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Post-Award Claims Management output generated per requirements
...
- [ ] Post-Award Claims Management completed successfully
...
### Related Skills
- Additional contracts post-award skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Contracts Engineer — Main execution
- **Supporting:** Contracts Post-Award Administrator — Document and data management
- **Oversight:** Contracts Post-Award Manager — Review, approval, and escalation

### Related Domain Knowledge
- Contracts Post-Award Domain Knowledge for role responsibilities and frameworks
- Contracts Post-Award Glossary for terminology, definitions, and abbreviations
