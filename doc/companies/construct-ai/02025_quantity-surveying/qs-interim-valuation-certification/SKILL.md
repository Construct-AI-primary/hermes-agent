---
title: QS Interim Valuation and Payment Certification
description: Prepare interim valuations, verify work completed, certify payment amounts, assess retention
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02025_quantity-surveying/qs-interim-valuation-certification
gigabrain_tags: disciplines, 02025_quantity-surveying, qs-interim-valuation-certification, quantity-surveying
openstinger_context: 02025_quantity_surveying_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/02025_quantity-surveying/agent-data/domain-knowledge/02025_DOMAIN-KNOWLEDGE.MD
---

# QS Interim Valuation and Payment Certification

## Overview
Prepare interim valuations, verify work completed, certify payment amounts, assess retention

**Announce at start:** "I'm using the qs-interim-valuation-certification skill for Quantity Surveying operations."

## When to Use This Skill
**Trigger Conditions:** Prepare interim valuations, verify work completed, certify payment amounts, assess retention task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Quantity Surveying domain knowledge)
...
1. Identify the specific quantity surveying task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare interim valuations, verify work completed, certify payment amounts, assess retention
...
4. Update quantity surveying records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] QS Interim Valuation and Payment Certification output generated per requirements
...
- [ ] QS Interim Valuation and Payment Certification completed successfully
...
### Related Skills
- Additional quantity surveying skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Quantity Surveyor — Main execution
- **Supporting:** Quantity Surveying Administrator — Document and data management
- **Oversight:** Quantity Surveying Manager — Review, approval, and escalation

### Related Domain Knowledge
- Quantity Surveying Domain Knowledge for role responsibilities and frameworks
- Quantity Surveying Glossary for terminology, definitions, and abbreviations
