---
title: QS Variation Assessment and Valuation
description: Assess and value variations, apply contract rates, determine fair valuation, document basis
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02025_quantity-surveying/qs-variation-assessment-valuation
gigabrain_tags: disciplines, 02025_quantity-surveying, qs-variation-assessment-valuation, quantity-surveying
...
# QS Variation Assessment and Valuation

## Overview
Assess and value variations, apply contract rates, determine fair valuation, document basis

**Announce at start:** "I'm using the qs-variation-assessment-valuation skill for Quantity Surveying operations."

## When to Use This Skill
**Trigger Conditions:** Assess and value variations, apply contract rates, determine fair valuation, document basis task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for assess and value variations, apply contract rates, determine fair valuation, document basis
...
- [ ] QS Variation Assessment and Valuation output generated per requirements
...
- [ ] QS Variation Assessment and Valuation completed successfully
