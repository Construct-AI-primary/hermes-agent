---
title: QS Cost Benchmarking and Advice
description: Provide cost benchmarking, rate analysis, and commercial advice to project team
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02025_quantity-surveying/qs-cost-benchmark-advice
gigabrain_tags: disciplines, 02025_quantity-surveying, qs-cost-benchmark-advice, quantity-surveying
...
# QS Cost Benchmarking and Advice

## Overview
Provide cost benchmarking, rate analysis, and commercial advice to project team

**Announce at start:** "I'm using the qs-cost-benchmark-advice skill for Quantity Surveying operations."

## When to Use This Skill
**Trigger Conditions:** Provide cost benchmarking, rate analysis, and commercial advice to project team task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for provide cost benchmarking, rate analysis, and commercial advice to project team
...
- [ ] QS Cost Benchmarking and Advice output generated per requirements
...
- [ ] QS Cost Benchmarking and Advice completed successfully
