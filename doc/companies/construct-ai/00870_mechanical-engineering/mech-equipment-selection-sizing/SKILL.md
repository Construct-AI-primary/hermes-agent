---
title: Mechanical Equipment Selection and Sizing
description: Select and size mechanical equipment including pumps, compressors, vessels, and heat exchangers
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00870_mechanical-engineering/mech-equipment-selection-sizing
gigabrain_tags: disciplines, 00870_mechanical-engineering, mech-equipment-selection-sizing, mechanical-engineering
openstinger_context: 00870_mechanical_engineering_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00870_mechanical-engineering/agent-data/domain-knowledge/00870_DOMAIN-KNOWLEDGE.MD
---

# Mechanical Equipment Selection and Sizing

## Overview
Select and size mechanical equipment including pumps, compressors, vessels, and heat exchangers

**Announce at start:** "I'm using the mech-equipment-selection-sizing skill for Mechanical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Select and size mechanical equipment including pumps, compressors, vessels, and heat exchangers task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Mechanical Engineering domain knowledge)
...
1. Identify the specific mechanical engineering task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for select and size mechanical equipment including pumps, compressors, vessels, and heat exchangers
...
4. Update mechanical engineering records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Mechanical Equipment Selection and Sizing output generated per requirements
...
- [ ] Mechanical Equipment Selection and Sizing completed successfully
...
### Related Skills
- Additional mechanical engineering skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Mechanical Engineer — Main execution
- **Supporting:** Mechanical Engineering Administrator — Document and data management
- **Oversight:** Mechanical Engineering Manager — Review, approval, and escalation

### Related Domain Knowledge
- Mechanical Engineering Domain Knowledge for role responsibilities and frameworks
- Mechanical Engineering Glossary for terminology, definitions, and abbreviations
