---
title: Design Drawing Control and Revision Management
description: Manage drawing registers, revisions, transmittals, ensure latest versions issued to site
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00800_design/design-drawing-control-revision
gigabrain_tags: disciplines, 00800_design, design-drawing-control-revision, design
openstinger_context: 00800_design_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00800_design/agent-data/domain-knowledge/00800_DOMAIN-KNOWLEDGE.MD
---

# Design Drawing Control and Revision Management

## Overview
Manage drawing registers, revisions, transmittals, ensure latest versions issued to site

**Announce at start:** "I'm using the design-drawing-control-revision skill for Design operations."

## When to Use This Skill
**Trigger Conditions:** Manage drawing registers, revisions, transmittals, ensure latest versions issued to site task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Design domain knowledge)
...
1. Identify the specific design task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage drawing registers, revisions, transmittals, ensure latest versions issued to site
...
4. Update design records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Design Drawing Control and Revision Management output generated per requirements
...
- [ ] Design Drawing Control and Revision Management completed successfully
...
### Related Skills
- Additional design skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Design Coordinator — Main execution
- **Supporting:** Design Administrator — Document and data management
- **Oversight:** Design Manager — Review, approval, and escalation

### Related Domain Knowledge
- Design Domain Knowledge for role responsibilities and frameworks
- Design Glossary for terminology, definitions, and abbreviations
