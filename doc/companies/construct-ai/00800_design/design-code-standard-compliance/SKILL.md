---
title: Design Code and Standard Compliance Verification
description: Verify designs comply with applicable codes, standards, and regulatory requirements
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00800_design/design-code-standard-compliance
gigabrain_tags: disciplines, 00800_design, design-code-standard-compliance, design
...
# Design Code and Standard Compliance Verification

## Overview
Verify designs comply with applicable codes, standards, and regulatory requirements

**Announce at start:** "I'm using the design-code-standard-compliance skill for Design operations."

## When to Use This Skill
**Trigger Conditions:** Verify designs comply with applicable codes, standards, and regulatory requirements task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for verify designs comply with applicable codes, standards, and regulatory requirements
...
- [ ] Design Code and Standard Compliance Verification output generated per requirements
...
- [ ] Design Code and Standard Compliance Verification completed successfully
...
### Related Agents
- **Primary:** Design Engineer — Main execution
