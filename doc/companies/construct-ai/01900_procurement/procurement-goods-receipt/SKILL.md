---
title: Procurement Goods Receipt and Verification
description: Manage goods receipt process including delivery verification, GRN processing, quantity and quality inspection, and non-conformance handling
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-goods-receipt
gigabrain_tags: disciplines, 01900_procurement, procurement-goods-receipt, procurement
...
# Procurement Goods Receipt and Verification

## Overview
Manage goods receipt process including delivery verification, GRN processing, quantity and quality inspection, and non-conformance handling

**Announce at start:** "I'm using the procurement-goods-receipt skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Manage goods receipt process including delivery verification, GRN processing, quantity and quality inspection, and non-conformance handling task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage goods receipt process including delivery verification, grn processing, quantity and quality inspection, and non-conformance handling
...
- [ ] Procurement Goods Receipt and Verification output generated per requirements
...
- [ ] Procurement Goods Receipt and Verification completed successfully
...
### Related Agents
- **Primary:** Stores Coordinator — Main execution
