...
description: Monitor and evaluate supplier performance including delivery timeliness, quality compliance, responsiveness, and overall performance rating
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-supplier-performance
gigabrain_tags: disciplines, 01900_procurement, procurement-supplier-performance, procurement
...
## Overview
Monitor and evaluate supplier performance including delivery timeliness, quality compliance, responsiveness, and overall performance rating

**Announce at start:** "I'm using the procurement-supplier-performance skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Monitor and evaluate supplier performance including delivery timeliness, quality compliance, responsiveness, and overall performance rating task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor and evaluate supplier performance including delivery timeliness, quality compliance, responsiveness, and overall performance rating
...
- [ ] Supplier Performance Management output generated per requirements
...
- [ ] Supplier Performance Management completed successfully
...
### Related Agents
- **Primary:** Procurement Officer — Main execution
