---
title: Local Employment Tracking and Reporting
description: Track local employment numbers, develop local skills training, report on local content metrics
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01600_local-content/lc-local-employment-tracking
gigabrain_tags: disciplines, 01600_local-content, lc-local-employment-tracking, local-content
openstinger_context: 01600_local_content_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/01600_local-content/agent-data/domain-knowledge/01600_DOMAIN-KNOWLEDGE.MD
---

# Local Employment Tracking and Reporting

## Overview
Track local employment numbers, develop local skills training, report on local content metrics

**Announce at start:** "I'm using the lc-local-employment-tracking skill for Local Content operations."

## When to Use This Skill
**Trigger Conditions:** Track local employment numbers, develop local skills training, report on local content metrics task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Local Content domain knowledge)
...
1. Identify the specific local content task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for track local employment numbers, develop local skills training, report on local content metrics
...
4. Update local content records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Local Employment Tracking and Reporting output generated per requirements
...
- [ ] Local Employment Tracking and Reporting completed successfully
...
### Related Skills
- Additional local content skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Local Content Officer — Main execution
- **Supporting:** Local Content Administrator — Document and data management
- **Oversight:** Local Content Manager — Review, approval, and escalation

### Related Domain Knowledge
- Local Content Domain Knowledge for role responsibilities and frameworks
- Local Content Glossary for terminology, definitions, and abbreviations
