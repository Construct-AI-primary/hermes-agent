---
title: PR Press Release and Media Content Development
description: Draft press releases, media statements, and public communications, coordinate distribution
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02100_public-relations/pr-press-release-development
gigabrain_tags: disciplines, 02100_public-relations, pr-press-release-development, public-relations
openstinger_context: 02100_public_relations_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/02100_public-relations/agent-data/domain-knowledge/02100_DOMAIN-KNOWLEDGE.MD
---

# PR Press Release and Media Content Development

## Overview
Draft press releases, media statements, and public communications, coordinate distribution

**Announce at start:** "I'm using the pr-press-release-development skill for Public Relations operations."

## When to Use This Skill
**Trigger Conditions:** Draft press releases, media statements, and public communications, coordinate distribution task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Public Relations domain knowledge)
...
1. Identify the specific public relations task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for draft press releases, media statements, and public communications, coordinate distribution
...
4. Update public relations records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] PR Press Release and Media Content Development output generated per requirements
...
- [ ] PR Press Release and Media Content Development completed successfully
...
### Related Skills
- Additional public relations skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** PR Coordinator — Main execution
- **Supporting:** Public Relations Administrator — Document and data management
- **Oversight:** Public Relations Manager — Review, approval, and escalation

### Related Domain Knowledge
- Public Relations Domain Knowledge for role responsibilities and frameworks
- Public Relations Glossary for terminology, definitions, and abbreviations
