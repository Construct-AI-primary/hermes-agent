---
title: Public-Relations Pr Event Management
description: PR event coordination
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02100_public-relations/pr-event-management
gigabrain_tags: disciplines, 02100_public-relations, pr-event-management, public-relations
...
# Public-Relations Pr Event Management

## Overview
PR event coordination
**Announce at start:** "I'm using the pr-event-management skill for Public Relations operations."

## When to Use This Skill
**Trigger Conditions:** PR event coordination task required
...
### Step 3: Execution
1. Apply discipline-specific pr event management methods
...
- [ ] Pr Event Management output generated
