---
title: FIDIC, NEC, and JCT Contract Interpretation
description: Interpret and apply provisions of FIDIC, NEC, and JCT standard forms, advise on clause meanings, and ensure compliance with standard contract requirements
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-fidic-nec-jct-interpretation
gigabrain_tags: disciplines, 00400_contracts, contracts-fidic-nec-jct-interpretation, contracts
...
# FIDIC, NEC, and JCT Contract Interpretation

## Overview
Interpret and apply provisions of FIDIC, NEC, and JCT standard forms, advise on clause meanings, and ensure compliance with standard contract requirements

**Announce at start:** "I'm using the contracts-fidic-nec-jct-interpretation skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Interpret and apply provisions of FIDIC, NEC, and JCT standard forms, advise on clause meanings, and ensure compliance with standard contract requirements task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for interpret and apply provisions of fidic, nec, and jct standard forms, advise on clause meanings, and ensure compliance with standard contract requirements
...
- [ ] FIDIC, NEC, and JCT Contract Interpretation output generated per requirements
...
- [ ] FIDIC, NEC, and JCT Contract Interpretation completed successfully
...
### Related Agents
- **Primary:** Contracts Manager — Main execution
