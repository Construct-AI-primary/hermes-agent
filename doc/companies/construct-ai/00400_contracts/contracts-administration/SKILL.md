...
description: Administer main contracts and subcontracts in accordance with applicable conditions, interpret clauses, advise project team on contractual rights and obligations, and monitor compliance
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-administration
gigabrain_tags: disciplines, 00400_contracts, contracts-administration, contracts
...
## Overview
Administer main contracts and subcontracts in accordance with applicable conditions, interpret clauses, advise project team on contractual rights and obligations, and monitor compliance

**Announce at start:** "I'm using the contracts-administration skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Administer main contracts and subcontracts in accordance with applicable conditions, interpret clauses, advise project team on contractual rights and obligations, and monitor compliance task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for administer main contracts and subcontracts in accordance with applicable conditions, interpret clauses, advise project team on contractual rights and obligations, and monitor compliance
...
- [ ] Contracts Administration output generated per requirements
...
- [ ] Contracts Administration completed successfully
