---
title: Logistics Log Supply Chain Coordination
description: Supply chain coordination
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01700_logistics/log-supply-chain-coordination
gigabrain_tags: disciplines, 01700_logistics, log-supply-chain-coordination, logistics
openstinger_context: logistics, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/01700_logistics/agent-data/domain-knowledge/01700_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/01700_logistics/agent-data/prompts/01700_AI-NATIVE-LOGISTICS-PROMPT.md
---

# Logistics Log Supply Chain Coordination

## Overview
Supply chain coordination
**Announce at start:** "I'm using the log-supply-chain-coordination skill for Logistics operations."

## When to Use This Skill
**Trigger Conditions:** Supply chain coordination task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the logistics task or request
...
### Step 3: Execution
1. Apply discipline-specific log supply chain coordination methods
...
3. Update logistics records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Log Supply Chain Coordination output generated
...
### Related Agents
- Logistics Coordinator — Primary agent
- Logistics Manager — Oversight agent
