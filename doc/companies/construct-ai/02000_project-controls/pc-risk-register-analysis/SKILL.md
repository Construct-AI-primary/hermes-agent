---
title: Project Controls Risk Register and Quantitative Risk Analysis
description: Maintain risk register, perform quantitative risk analysis, produce risk reports, track mitigations
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02000_project-controls/pc-risk-register-analysis
gigabrain_tags: disciplines, 02000_project-controls, pc-risk-register-analysis, project-controls
openstinger_context: 02000_project_controls_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/02000_project-controls/agent-data/domain-knowledge/02000_DOMAIN-KNOWLEDGE.MD
---

# Project Controls Risk Register and Quantitative Risk Analysis

## Overview
Maintain risk register, perform quantitative risk analysis, produce risk reports, track mitigations

**Announce at start:** "I'm using the pc-risk-register-analysis skill for Project Controls operations."

## When to Use This Skill
**Trigger Conditions:** Maintain risk register, perform quantitative risk analysis, produce risk reports, track mitigations task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Project Controls domain knowledge)
...
1. Identify the specific project controls task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for maintain risk register, perform quantitative risk analysis, produce risk reports, track mitigations
...
4. Update project controls records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Project Controls Risk Register and Quantitative Risk Analysis output generated per requirements
...
- [ ] Project Controls Risk Register and Quantitative Risk Analysis completed successfully
...
### Related Skills
- Additional project controls skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Planning Engineer — Main execution
- **Supporting:** Project Controls Administrator — Document and data management
- **Oversight:** Project Controls Manager — Review, approval, and escalation

### Related Domain Knowledge
- Project Controls Domain Knowledge for role responsibilities and frameworks
- Project Controls Glossary for terminology, definitions, and abbreviations
