---
title: Project Controls Schedule Integration and Analysis
description: Integrate schedules, analyze critical path, assess schedule risks, report schedule status
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02000_project-controls/pc-schedule-integration-analysis
gigabrain_tags: disciplines, 02000_project-controls, pc-schedule-integration-analysis, project-controls
...
# Project Controls Schedule Integration and Analysis

## Overview
Integrate schedules, analyze critical path, assess schedule risks, report schedule status

**Announce at start:** "I'm using the pc-schedule-integration-analysis skill for Project Controls operations."

## When to Use This Skill
**Trigger Conditions:** Integrate schedules, analyze critical path, assess schedule risks, report schedule status task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for integrate schedules, analyze critical path, assess schedule risks, report schedule status
...
- [ ] Project Controls Schedule Integration and Analysis output generated per requirements
...
- [ ] Project Controls Schedule Integration and Analysis completed successfully
