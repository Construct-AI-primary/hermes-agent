---
title: Project Controls Earned Value Performance Analysis
description: Perform EVM analysis, calculate SPI/CPI, forecast completion, produce earned value reports
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02000_project-controls/pc-earned-value-performance
gigabrain_tags: disciplines, 02000_project-controls, pc-earned-value-performance, project-controls
...
# Project Controls Earned Value Performance Analysis

## Overview
Perform EVM analysis, calculate SPI/CPI, forecast completion, produce earned value reports

**Announce at start:** "I'm using the pc-earned-value-performance skill for Project Controls operations."

## When to Use This Skill
**Trigger Conditions:** Perform EVM analysis, calculate SPI/CPI, forecast completion, produce earned value reports task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for perform evm analysis, calculate spi/cpi, forecast completion, produce earned value reports
...
- [ ] Project Controls Earned Value Performance Analysis output generated per requirements
...
- [ ] Project Controls Earned Value Performance Analysis completed successfully
