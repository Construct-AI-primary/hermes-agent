---
title: Project Controls Change Control Workflow Management
description: Manage change control process, evaluate change impacts, track approvals, update baseline
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02000_project-controls/pc-change-control-workflow
gigabrain_tags: disciplines, 02000_project-controls, pc-change-control-workflow, project-controls
...
# Project Controls Change Control Workflow Management

## Overview
Manage change control process, evaluate change impacts, track approvals, update baseline

**Announce at start:** "I'm using the pc-change-control-workflow skill for Project Controls operations."

## When to Use This Skill
**Trigger Conditions:** Manage change control process, evaluate change impacts, track approvals, update baseline task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage change control process, evaluate change impacts, track approvals, update baseline
...
- [ ] Project Controls Change Control Workflow Management output generated per requirements
...
- [ ] Project Controls Change Control Workflow Management completed successfully
...
### Related Agents
- **Primary:** Project Controls Manager — Main execution
