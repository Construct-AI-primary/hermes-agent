---
title: Process PFD and P&ID Development and Review
description: Develop and review PFDs and P&IDs, ensure design intent captured, coordinate with instrumentation
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00871_process-engineering/process-pfd-pid-development-Review
gigabrain_tags: disciplines, 00871_process-engineering, process-pfd-pid-development-Review, process-engineering
openstinger_context: 00871_process_engineering_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00871_process-engineering/agent-data/domain-knowledge/00871_DOMAIN-KNOWLEDGE.MD
---

# Process PFD and P&ID Development and Review

## Overview
Develop and review PFDs and P&IDs, ensure design intent captured, coordinate with instrumentation

**Announce at start:** "I'm using the process-pfd-pid-development-Review skill for Process Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Develop and review PFDs and P&IDs, ensure design intent captured, coordinate with instrumentation task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Process Engineering domain knowledge)
...
1. Identify the specific process engineering task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for develop and review pfds and p&ids, ensure design intent captured, coordinate with instrumentation
...
4. Update process engineering records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Process PFD and P&ID Development and Review output generated per requirements
...
- [ ] Process PFD and P&ID Development and Review completed successfully
...
### Related Skills
- Additional process engineering skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Process Engineer — Main execution
- **Supporting:** Process Engineering Administrator — Document and data management
- **Oversight:** Process Engineering Manager — Review, approval, and escalation

### Related Domain Knowledge
- Process Engineering Domain Knowledge for role responsibilities and frameworks
- Process Engineering Glossary for terminology, definitions, and abbreviations
