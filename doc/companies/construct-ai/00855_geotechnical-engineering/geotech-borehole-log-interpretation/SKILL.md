---
title: Geotechnical Borehole Log Interpretation
description: Interpret borehole logs, classify soil/rock, determine engineering properties from test data
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00855_geotechnical-engineering/geotech-borehole-log-interpretation
gigabrain_tags: disciplines, 00855_geotechnical-engineering, geotech-borehole-log-interpretation, geotechnical-engineering
...
# Geotechnical Borehole Log Interpretation

## Overview
Interpret borehole logs, classify soil/rock, determine engineering properties from test data

**Announce at start:** "I'm using the geotech-borehole-log-interpretation skill for Geotechnical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Interpret borehole logs, classify soil/rock, determine engineering properties from test data task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for interpret borehole logs, classify soil/rock, determine engineering properties from test data
...
- [ ] Geotechnical Borehole Log Interpretation output generated per requirements
...
- [ ] Geotechnical Borehole Log Interpretation completed successfully
