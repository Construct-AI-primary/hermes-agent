---
title: Construction Defect Management
description: Identify defects, assess severity, assign rectification, verify completion, maintain defect register
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-defect-management
gigabrain_tags: disciplines, 00300_construction, construct-defect-management, construction
...
## Overview
Identify defects, assess severity, assign rectification, verify completion, maintain defect register

**Announce at start:** "I'm using the construct-defect-management skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Identify defects, assess severity, assign rectification, verify completion, maintain defect register task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for identify defects, assess severity, assign rectification, verify completion, maintain defect register
...
- [ ] Construction Defect Management output generated per requirements
...
- [ ] Construction Defect Management completed successfully
