---
title: Construction Handover Management
description: Manage construction handovers, verify completion certificates, compile O&M documents, coordinate commissioning
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-handover-management
gigabrain_tags: disciplines, 00300_construction, construct-handover-management, construction
...
## Overview
Manage construction handovers, verify completion certificates, compile O&M documents, coordinate commissioning

**Announce at start:** "I'm using the construct-handover-management skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Manage construction handovers, verify completion certificates, compile O&M documents, coordinate commissioning task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage construction handovers, verify completion certificates, compile o&m documents, coordinate commissioning
...
- [ ] Construction Handover Management output generated per requirements
...
- [ ] Construction Handover Management completed successfully
...
### Related Agents
- **Primary:** Construction Manager — Main execution
