---
title: Construction Progress Measurement and Tracking
description: Measure physical progress, produce daily/weekly reports, track against baseline, identify variances
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-progress-measurement-tracking
gigabrain_tags: disciplines, 00300_construction, construct-progress-measurement-tracking, construction
...
# Construction Progress Measurement and Tracking

## Overview
Measure physical progress, produce daily/weekly reports, track against baseline, identify variances

**Announce at start:** "I'm using the construct-progress-measurement-tracking skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Measure physical progress, produce daily/weekly reports, track against baseline, identify variances task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for measure physical progress, produce daily/weekly reports, track against baseline, identify variances
...
- [ ] Construction Progress Measurement and Tracking output generated per requirements
...
- [ ] Construction Progress Measurement and Tracking completed successfully
