---
title: Construction Site Inspection and Supervision
description: Conduct site inspections, verify conformance with drawings/specs, identify defects, direct rectification
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-site-inspection-supervision
gigabrain_tags: disciplines, 00300_construction, construct-site-inspection-supervision, construction
...
## Overview
Conduct site inspections, verify conformance with drawings/specs, identify defects, direct rectification

**Announce at start:** "I'm using the construct-site-inspection-supervision skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Conduct site inspections, verify conformance with drawings/specs, identify defects, direct rectification task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for conduct site inspections, verify conformance with drawings/specs, identify defects, direct rectification
...
- [ ] Construction Site Inspection and Supervision output generated per requirements
...
- [ ] Construction Site Inspection and Supervision completed successfully
