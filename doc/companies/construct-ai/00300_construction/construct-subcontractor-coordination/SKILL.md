---
title: Construction Subcontractor Coordination
description: Coordinate subcontractor work, verify RAMS compliance, manage interfaces, track deliverables
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-subcontractor-coordination
gigabrain_tags: disciplines, 00300_construction, construct-subcontractor-coordination, construction
...
## Overview
Coordinate subcontractor work, verify RAMS compliance, manage interfaces, track deliverables

**Announce at start:** "I'm using the construct-subcontractor-coordination skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate subcontractor work, verify RAMS compliance, manage interfaces, track deliverables task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate subcontractor work, verify rams compliance, manage interfaces, track deliverables
...
- [ ] Construction Subcontractor Coordination output generated per requirements
...
- [ ] Construction Subcontractor Coordination completed successfully
