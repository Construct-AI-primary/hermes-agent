---
title: Quality-Control Qc Defect Tracking
description: Defect tracking and resolution
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02250_quality-control/qc-defect-tracking
gigabrain_tags: disciplines, 02250_quality-control, qc-defect-tracking, quality-control
...
# Quality-Control Qc Defect Tracking

## Overview
Defect tracking and resolution
**Announce at start:** "I'm using the qc-defect-tracking skill for Quality Control operations."

## When to Use This Skill
**Trigger Conditions:** Defect tracking and resolution task required
...
### Step 3: Execution
1. Apply discipline-specific qc defect tracking methods
...
- [ ] Qc Defect Tracking output generated
