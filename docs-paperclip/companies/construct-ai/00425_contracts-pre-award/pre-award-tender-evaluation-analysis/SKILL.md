---
title: Tender Evaluation and Analysis
description: Evaluate tender submissions including technical compliance, commercial analysis, risk assessment, and best value determination
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-tender-evaluation-analysis
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-tender-evaluation-analysis, contracts-pre-award
...
## Overview
Evaluate tender submissions including technical compliance, commercial analysis, risk assessment, and best value determination

**Announce at start:** "I'm using the pre-award-tender-evaluation-analysis skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Evaluate tender submissions including technical compliance, commercial analysis, risk assessment, and best value determination task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for evaluate tender submissions including technical compliance, commercial analysis, risk assessment, and best value determination
...
- [ ] Tender Evaluation and Analysis output generated per requirements
...
- [ ] Tender Evaluation and Analysis completed successfully
...
### Related Agents
- **Primary:** Tender Evaluation Coordinator — Main execution
