---
title: Pre-Award Procurement Strategy Development
description: Develop procurement strategies including contract packaging, contract type selection, procurement scheduling, and risk allocation across contract packages
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-procurement-strategy
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-procurement-strategy, contracts-pre-award
openstinger_context: 00425_contracts_pre_award_operations, skill-execution
...
# Pre-Award Procurement Strategy Development

## Overview
Develop procurement strategies including contract packaging, contract type selection, procurement scheduling, and risk allocation across contract packages

**Announce at start:** "I'm using the pre-award-procurement-strategy skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Develop procurement strategies including contract packaging, contract type selection, procurement scheduling, and risk allocation across contract packages task required, contracts pre-award team task or request received
**Prerequisites:**
- Domain knowledge available (Contracts Pre-Award domain knowledge)
...
1. Identify the specific contracts pre-award task or request triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for develop procurement strategies including contract packaging, contract type selection, procurement scheduling, and risk allocation across contract packages
...
4. Update contracts pre-award records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Pre-Award Procurement Strategy Development output generated per requirements
...
- [ ] Pre-Award Procurement Strategy Development completed successfully
...
### Related Skills
- Additional contracts pre-award skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Procurement Manager — Main execution
- **Supporting:** Contracts Pre-Award Administrator for document and data management
- **Oversight:** Contracts Pre-Award Manager for review, approval, and escalation

### Related Domain Knowledge
- Contracts Pre-Award Domain Knowledge for role responsibilities and frameworks
- Contracts Pre-Award Glossary for terminology, definitions, and abbreviations
