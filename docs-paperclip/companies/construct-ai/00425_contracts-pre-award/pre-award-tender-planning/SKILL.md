---
title: Tender Planning and Preparation
description: Plan tender processes including tender document preparation, evaluation criteria development, tender panel formation, and procurement scheduling
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-tender-planning
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-tender-planning, contracts-pre-award
...
## Overview
Plan tender processes including tender document preparation, evaluation criteria development, tender panel formation, and procurement scheduling

**Announce at start:** "I'm using the pre-award-tender-planning skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Plan tender processes including tender document preparation, evaluation criteria development, tender panel formation, and procurement scheduling task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for plan tender processes including tender document preparation, evaluation criteria development, tender panel formation, and procurement scheduling
...
- [ ] Tender Planning and Preparation output generated per requirements
...
- [ ] Tender Planning and Preparation completed successfully
