...
description: Prepare comprehensive bid documents including specifications, conditions of contract, bill of quantities, tender instructions, and evaluation criteria
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-bid-document-preparation
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-bid-document-preparation, contracts-pre-award
...
## Overview
Prepare comprehensive bid documents including specifications, conditions of contract, bill of quantities, tender instructions, and evaluation criteria

**Announce at start:** "I'm using the pre-award-bid-document-preparation skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Prepare comprehensive bid documents including specifications, conditions of contract, bill of quantities, tender instructions, and evaluation criteria task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare comprehensive bid documents including specifications, conditions of contract, bill of quantities, tender instructions, and evaluation criteria
...
- [ ] Bid Document Preparation output generated per requirements
...
- [ ] Bid Document Preparation completed successfully
...
### Related Agents
- **Primary:** Bid Coordinator — Main execution
