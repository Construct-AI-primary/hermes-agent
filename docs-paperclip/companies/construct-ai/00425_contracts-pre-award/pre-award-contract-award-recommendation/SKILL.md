---
title: Contract Award Recommendation
description: Prepare contract award recommendations including evaluation summary, risk assessment, commercial recommendation, and award documentation
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-contract-award-recommendation
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-contract-award-recommendation, contracts-pre-award
...
## Overview
Prepare contract award recommendations including evaluation summary, risk assessment, commercial recommendation, and award documentation

**Announce at start:** "I'm using the pre-award-contract-award-recommendation skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Prepare contract award recommendations including evaluation summary, risk assessment, commercial recommendation, and award documentation task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare contract award recommendations including evaluation summary, risk assessment, commercial recommendation, and award documentation
...
- [ ] Contract Award Recommendation output generated per requirements
...
- [ ] Contract Award Recommendation completed successfully
