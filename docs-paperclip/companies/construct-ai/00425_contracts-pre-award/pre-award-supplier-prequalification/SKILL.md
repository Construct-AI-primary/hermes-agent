...
description: Conduct supplier prequalification including technical capability assessment, financial stability evaluation, past performance review, and prequalification recommendation
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-supplier-prequalification
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-supplier-prequalification, contracts-pre-award
...
## Overview
Conduct supplier prequalification including technical capability assessment, financial stability evaluation, past performance review, and prequalification recommendation

**Announce at start:** "I'm using the pre-award-supplier-prequalification skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Conduct supplier prequalification including technical capability assessment, financial stability evaluation, past performance review, and prequalification recommendation task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for conduct supplier prequalification including technical capability assessment, financial stability evaluation, past performance review, and prequalification recommendation
...
- [ ] Supplier Prequalification output generated per requirements
...
- [ ] Supplier Prequalification completed successfully
...
### Related Agents
- **Primary:** Supplier Coordinator — Main execution
