---
title: Pre-Award Negotiation Preparation and Support
description: Prepare for contract negotiations including position development, target pricing, risk allocation strategy, and negotiation playbooks
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00425_contracts-pre-award/pre-award-negotiation-preparation
gigabrain_tags: disciplines, 00425_contracts-pre-award, pre-award-negotiation-preparation, contracts-pre-award
...
# Pre-Award Negotiation Preparation and Support

## Overview
Prepare for contract negotiations including position development, target pricing, risk allocation strategy, and negotiation playbooks

**Announce at start:** "I'm using the pre-award-negotiation-preparation skill for Contracts Pre-Award operations."

## When to Use This Skill
**Trigger Conditions:** Prepare for contract negotiations including position development, target pricing, risk allocation strategy, and negotiation playbooks task required, contracts pre-award team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare for contract negotiations including position development, target pricing, risk allocation strategy, and negotiation playbooks
...
- [ ] Pre-Award Negotiation Preparation and Support output generated per requirements
...
- [ ] Pre-Award Negotiation Preparation and Support completed successfully
...
### Related Agents
- **Primary:** Tender Coordinator — Main execution
