---
title: Inspection Non-Conformance Tracking and Resolution
description: Record non-conformances, track corrective actions, verify closure, maintain NCR register
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02075_inspection/insp-nonconformance-tracking
gigabrain_tags: disciplines, 02075_inspection, insp-nonconformance-tracking, inspection
...
# Inspection Non-Conformance Tracking and Resolution

## Overview
Record non-conformances, track corrective actions, verify closure, maintain NCR register

**Announce at start:** "I'm using the insp-nonconformance-tracking skill for Inspection operations."

## When to Use This Skill
**Trigger Conditions:** Record non-conformances, track corrective actions, verify closure, maintain NCR register task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for record non-conformances, track corrective actions, verify closure, maintain ncr register
...
- [ ] Inspection Non-Conformance Tracking and Resolution output generated per requirements
...
- [ ] Inspection Non-Conformance Tracking and Resolution completed successfully
...
### Related Agents
- **Primary:** Inspection Manager — Main execution
