---
title: Inspection Insp Inspection Planning
description: Inspection planning and scheduling
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02075_inspection/insp-inspection-planning
gigabrain_tags: disciplines, 02075_inspection, insp-inspection-planning, inspection
openstinger_context: inspection, skill-execution
...
# Inspection Insp Inspection Planning

## Overview
Inspection planning and scheduling
**Announce at start:** "I'm using the insp-inspection-planning skill for Inspection operations."

## When to Use This Skill
**Trigger Conditions:** Inspection planning and scheduling task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the inspection task or request
...
### Step 3: Execution
1. Apply discipline-specific insp inspection planning methods
...
3. Update inspection records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Insp Inspection Planning output generated
...
## Cross-References
### Related Skills
- Additional inspection skills
### Related Agents
- Inspection Coordinator — Primary agent
- Inspection Manager — Oversight agent
