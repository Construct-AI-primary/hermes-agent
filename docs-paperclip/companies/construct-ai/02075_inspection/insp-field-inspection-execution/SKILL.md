---
title: Field Inspection Execution and Documentation
description: Execute field inspections, document findings, photograph non-conformances, complete inspection reports
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02075_inspection/insp-field-inspection-execution
gigabrain_tags: disciplines, 02075_inspection, insp-field-inspection-execution, inspection
openstinger_context: 02075_inspection_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/02075_inspection/agent-data/domain-knowledge/02075_DOMAIN-KNOWLEDGE.MD
---

# Field Inspection Execution and Documentation

## Overview
Execute field inspections, document findings, photograph non-conformances, complete inspection reports

**Announce at start:** "I'm using the insp-field-inspection-execution skill for Inspection operations."

## When to Use This Skill
**Trigger Conditions:** Execute field inspections, document findings, photograph non-conformances, complete inspection reports task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Inspection domain knowledge)
...
1. Identify the specific inspection task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for execute field inspections, document findings, photograph non-conformances, complete inspection reports
...
4. Update inspection records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Field Inspection Execution and Documentation output generated per requirements
...
- [ ] Field Inspection Execution and Documentation completed successfully
...
### Related Skills
- Additional inspection skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Inspector — Main execution
- **Supporting:** Inspection Administrator — Document and data management
- **Oversight:** Inspection Manager — Review, approval, and escalation

### Related Domain Knowledge
- Inspection Domain Knowledge for role responsibilities and frameworks
- Inspection Glossary for terminology, definitions, and abbreviations
