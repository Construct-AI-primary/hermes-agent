---
title: Chemical Process Safety Case Development
description: Develop and maintain process safety cases including risk assessments and mitigation strategies
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00835_chemical-engineering/chem-process-safety-case
gigabrain_tags: disciplines, 00835_chemical-engineering, chem-process-safety-case, chemical-engineering
...
# Chemical Process Safety Case Development

## Overview
Develop and maintain process safety cases including risk assessments and mitigation strategies

**Announce at start:** "I'm using the chem-process-safety-case skill for Chemical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Develop and maintain process safety cases including risk assessments and mitigation strategies task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for develop and maintain process safety cases including risk assessments and mitigation strategies
...
- [ ] Chemical Process Safety Case Development output generated per requirements
...
- [ ] Chemical Process Safety Case Development completed successfully
...
### Related Agents
- **Primary:** Process Safety Engineer — Main execution
