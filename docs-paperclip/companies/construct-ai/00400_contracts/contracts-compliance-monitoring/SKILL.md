---
title: Contracts Compliance Monitoring
description: Monitor contract compliance by all parties, ensure subcontractor compliance with programme, quality, and HSE requirements, track contractual milestones
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-compliance-monitoring
gigabrain_tags: disciplines, 00400_contracts, contracts-compliance-monitoring, contracts
...
## Overview
Monitor contract compliance by all parties, ensure subcontractor compliance with programme, quality, and HSE requirements, track contractual milestones

**Announce at start:** "I'm using the contracts-compliance-monitoring skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Monitor contract compliance by all parties, ensure subcontractor compliance with programme, quality, and HSE requirements, track contractual milestones task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor contract compliance by all parties, ensure subcontractor compliance with programme, quality, and hse requirements, track contractual milestones
...
- [ ] Contracts Compliance Monitoring output generated per requirements
...
- [ ] Contracts Compliance Monitoring completed successfully
