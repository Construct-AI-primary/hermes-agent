---
title: Contracts Claims Management
description: Identify potential claims, prepare claim submissions with supporting evidence, evaluate and respond to claims from clients and subcontractors, support dispute resolution
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-claims-management
gigabrain_tags: disciplines, 00400_contracts, contracts-claims-management, contracts
...
## Overview
Identify potential claims, prepare claim submissions with supporting evidence, evaluate and respond to claims from clients and subcontractors, support dispute resolution

**Announce at start:** "I'm using the contracts-claims-management skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Identify potential claims, prepare claim submissions with supporting evidence, evaluate and respond to claims from clients and subcontractors, support dispute resolution task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for identify potential claims, prepare claim submissions with supporting evidence, evaluate and respond to claims from clients and subcontractors, support dispute resolution
...
- [ ] Contracts Claims Management output generated per requirements
...
- [ ] Contracts Claims Management completed successfully
