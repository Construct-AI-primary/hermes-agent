---
title: Subcontract Lifecycle Management
description: Manage entire subcontract lifecycle from preparation through award, administration, and close-out; ensure subcontracts are aligned with main contract flow-down requirements
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-subcontract-lifecycle
gigabrain_tags: disciplines, 00400_contracts, contracts-subcontract-lifecycle, contracts
...
## Overview
Manage entire subcontract lifecycle from preparation through award, administration, and close-out; ensure subcontracts are aligned with main contract flow-down requirements

**Announce at start:** "I'm using the contracts-subcontract-lifecycle skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Manage entire subcontract lifecycle from preparation through award, administration, and close-out; ensure subcontracts are aligned with main contract flow-down requirements task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage entire subcontract lifecycle from preparation through award, administration, and close-out; ensure subcontracts are aligned with main contract flow-down requirements
...
- [ ] Subcontract Lifecycle Management output generated per requirements
...
- [ ] Subcontract Lifecycle Management completed successfully
