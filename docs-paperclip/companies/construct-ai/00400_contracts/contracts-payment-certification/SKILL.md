---
title: Contracts Payment Administration and Certification
description: Administer contract payments, certify subcontract invoices, verify work completed against measurements, manage retention and release procedures
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-payment-certification
gigabrain_tags: disciplines, 00400_contracts, contracts-payment-certification, contracts
...
# Contracts Payment Administration and Certification

## Overview
Administer contract payments, certify subcontract invoices, verify work completed against measurements, manage retention and release procedures

**Announce at start:** "I'm using the contracts-payment-certification skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Administer contract payments, certify subcontract invoices, verify work completed against measurements, manage retention and release procedures task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for administer contract payments, certify subcontract invoices, verify work completed against measurements, manage retention and release procedures
...
- [ ] Contracts Payment Administration and Certification output generated per requirements
...
- [ ] Contracts Payment Administration and Certification completed successfully
