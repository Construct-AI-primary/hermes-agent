---
title: Variation Assessment and Processing
description: Identify, assess, and process variations including impact assessment, submission preparation, negotiation support, and status tracking through agreement
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00400_contracts/contracts-variation-assessment
gigabrain_tags: disciplines, 00400_contracts, contracts-variation-assessment, contracts
...
# Variation Assessment and Processing

## Overview
Identify, assess, and process variations including impact assessment, submission preparation, negotiation support, and status tracking through agreement

**Announce at start:** "I'm using the contracts-variation-assessment skill for Contracts operations."

## When to Use This Skill
**Trigger Conditions:** Identify, assess, and process variations including impact assessment, submission preparation, negotiation support, and status tracking through agreement task required, contracts team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for identify, assess, and process variations including impact assessment, submission preparation, negotiation support, and status tracking through agreement
...
- [ ] Variation Assessment and Processing output generated per requirements
...
- [ ] Variation Assessment and Processing completed successfully
...
### Related Agents
- **Primary:** Contracts Engineer — Main execution
