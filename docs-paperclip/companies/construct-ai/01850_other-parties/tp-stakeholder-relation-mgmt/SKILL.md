...
description: Manage relationships with third parties, conduct engagement, address concerns, maintain records
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01850_other-parties/tp-stakeholder-relation-mgmt
gigabrain_tags: disciplines, 01850_other-parties, tp-stakeholder-relation-mgmt, other-parties
...
## Overview
Manage relationships with third parties, conduct engagement, address concerns, maintain records

**Announce at start:** "I'm using the tp-stakeholder-relation-mgmt skill for Other Parties operations."

## When to Use This Skill
**Trigger Conditions:** Manage relationships with third parties, conduct engagement, address concerns, maintain records task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage relationships with third parties, conduct engagement, address concerns, maintain records
...
- [ ] Stakeholder Relationship Management output generated per requirements
...
- [ ] Stakeholder Relationship Management completed successfully
