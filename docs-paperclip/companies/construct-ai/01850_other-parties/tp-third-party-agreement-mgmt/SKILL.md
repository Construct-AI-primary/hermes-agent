---
title: Third-Party Agreement Management
description: Manage third-party agreements, track obligations, coordinate performance monitoring, administer renewals
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01850_other-parties/tp-third-party-agreement-mgmt
gigabrain_tags: disciplines, 01850_other-parties, tp-third-party-agreement-mgmt, other-parties
openstinger_context: 01850_other_parties_operations, skill-execution
...
## Overview
Manage third-party agreements, track obligations, coordinate performance monitoring, administer renewals

**Announce at start:** "I'm using the tp-third-party-agreement-mgmt skill for Other Parties operations."

## When to Use This Skill
**Trigger Conditions:** Manage third-party agreements, track obligations, coordinate performance monitoring, administer renewals task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Other Parties domain knowledge)
...
1. Identify the specific other parties task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage third-party agreements, track obligations, coordinate performance monitoring, administer renewals
...
4. Update other parties records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Third-Party Agreement Management output generated per requirements
...
- [ ] Third-Party Agreement Management completed successfully
...
### Related Skills
- Additional other parties skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Stakeholder Manager — Main execution
- **Supporting:** Other Parties Administrator — Document and data management
- **Oversight:** Other Parties Manager — Review, approval, and escalation

### Related Domain Knowledge
- Other Parties Domain Knowledge for role responsibilities and frameworks
- Other Parties Glossary for terminology, definitions, and abbreviations
