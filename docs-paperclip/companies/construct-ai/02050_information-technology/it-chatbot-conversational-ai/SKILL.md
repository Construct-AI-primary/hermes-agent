---
title: IT Chatbot and Conversational AI Systems
description: Manage base chatbot architecture, discipline-specific AI agents, state-aware assistants, and voice call management systems
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02050_information-technology/it-chatbot-conversational-ai
gigabrain_tags: disciplines, 02050_information-technology, it-chatbot-conversational-ai, information-technology
...
# IT Chatbot and Conversational AI Systems

## Overview
Manage base chatbot architecture, discipline-specific AI agents, state-aware assistants, and voice call management systems

**Announce at start:** "I'm using the it-chatbot-conversational-ai skill for Information Technology operations."

## When to Use This Skill
**Trigger Conditions:** Manage base chatbot architecture, discipline-specific AI agents, state-aware assistants, and voice call management systems task required, information technology team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage base chatbot architecture, discipline-specific ai agents, state-aware assistants, and voice call management systems
...
- [ ] IT Chatbot and Conversational AI Systems output generated per requirements
...
- [ ] IT Chatbot and Conversational AI Systems completed successfully
...
### Related Agents
- **Primary:** Support Technician — Main execution
