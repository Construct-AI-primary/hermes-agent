---
title: IT Error Tracking, Discovery, and Classification
description: Manage error tracking system including automated discovery, classification, pattern analysis, and resolution workflow optimization
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02050_information-technology/it-error-tracking-discovery
gigabrain_tags: disciplines, 02050_information-technology, it-error-tracking-discovery, information-technology
...
# IT Error Tracking, Discovery, and Classification

## Overview
Manage error tracking system including automated discovery, classification, pattern analysis, and resolution workflow optimization

**Announce at start:** "I'm using the it-error-tracking-discovery skill for Information Technology operations."

## When to Use This Skill
**Trigger Conditions:** Manage error tracking system including automated discovery, classification, pattern analysis, and resolution workflow optimization task required, information technology team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage error tracking system including automated discovery, classification, pattern analysis, and resolution workflow optimization
...
- [ ] IT Error Tracking, Discovery, and Classification output generated per requirements
...
- [ ] IT Error Tracking, Discovery, and Classification completed successfully
