---
title: IT System Architecture Management
description: Manage system architecture including page components, state management, navigation systems, and routing; ensure architecture supports all discipline workflows
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02050_information-technology/it-system-architecture-management
gigabrain_tags: disciplines, 02050_information-technology, it-system-architecture-management, information-technology
...
# IT System Architecture Management

## Overview
Manage system architecture including page components, state management, navigation systems, and routing; ensure architecture supports all discipline workflows

**Announce at start:** "I'm using the it-system-architecture-management skill for Information Technology operations."

## When to Use This Skill
**Trigger Conditions:** Manage system architecture including page components, state management, navigation systems, and routing; ensure architecture supports all discipline workflows task required, information technology team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage system architecture including page components, state management, navigation systems, and routing; ensure architecture supports all discipline workflows
...
- [ ] IT System Architecture Management output generated per requirements
...
- [ ] IT System Architecture Management completed successfully
