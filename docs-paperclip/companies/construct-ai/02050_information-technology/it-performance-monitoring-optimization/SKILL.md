---
title: IT Performance Monitoring and Optimization
description: Monitor system performance, identify bottlenecks, optimize query performance, and ensure system availability and reliability
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02050_information-technology/it-performance-monitoring-optimization
gigabrain_tags: disciplines, 02050_information-technology, it-performance-monitoring-optimization, information-technology
...
## Overview
Monitor system performance, identify bottlenecks, optimize query performance, and ensure system availability and reliability

**Announce at start:** "I'm using the it-performance-monitoring-optimization skill for Information Technology operations."

## When to Use This Skill
**Trigger Conditions:** Monitor system performance, identify bottlenecks, optimize query performance, and ensure system availability and reliability task required, information technology team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor system performance, identify bottlenecks, optimize query performance, and ensure system availability and reliability
...
- [ ] IT Performance Monitoring and Optimization output generated per requirements
...
- [ ] IT Performance Monitoring and Optimization completed successfully
