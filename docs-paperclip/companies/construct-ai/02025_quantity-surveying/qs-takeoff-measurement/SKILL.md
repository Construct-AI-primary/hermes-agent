---
title: QS Quantity Take-Off and Measurement
description: Perform measurement and take-off from drawings/BOQs, compile quantities, verify against contract quantities
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02025_quantity-surveying/qs-takeoff-measurement
gigabrain_tags: disciplines, 02025_quantity-surveying, qs-takeoff-measurement, quantity-surveying
...
# QS Quantity Take-Off and Measurement

## Overview
Perform measurement and take-off from drawings/BOQs, compile quantities, verify against contract quantities

**Announce at start:** "I'm using the qs-takeoff-measurement skill for Quantity Surveying operations."

## When to Use This Skill
**Trigger Conditions:** Perform measurement and take-off from drawings/BOQs, compile quantities, verify against contract quantities task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for perform measurement and take-off from drawings/boqs, compile quantities, verify against contract quantities
...
- [ ] QS Quantity Take-Off and Measurement output generated per requirements
...
- [ ] QS Quantity Take-Off and Measurement completed successfully
