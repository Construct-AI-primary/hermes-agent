---
title: Local Supplier Development and Support
description: Identify and develop local suppliers, provide capability building, track development plans
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01600_local-content/lc-local-supplier-development
gigabrain_tags: disciplines, 01600_local-content, lc-local-supplier-development, local-content
...
# Local Supplier Development and Support

## Overview
Identify and develop local suppliers, provide capability building, track development plans

**Announce at start:** "I'm using the lc-local-supplier-development skill for Local Content operations."

## When to Use This Skill
**Trigger Conditions:** Identify and develop local suppliers, provide capability building, track development plans task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for identify and develop local suppliers, provide capability building, track development plans
...
- [ ] Local Supplier Development and Support output generated per requirements
...
- [ ] Local Supplier Development and Support completed successfully
