---
title: Procurement Vendor and Approved Vendor List Management
description: Manage approved vendor list, coordinate vendor prequalification, conduct vendor audits, and maintain vendor database
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-vendor-management
gigabrain_tags: disciplines, 01900_procurement, procurement-vendor-management, procurement
...
# Procurement Vendor and Approved Vendor List Management

## Overview
Manage approved vendor list, coordinate vendor prequalification, conduct vendor audits, and maintain vendor database

**Announce at start:** "I'm using the procurement-vendor-management skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Manage approved vendor list, coordinate vendor prequalification, conduct vendor audits, and maintain vendor database task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage approved vendor list, coordinate vendor prequalification, conduct vendor audits, and maintain vendor database
...
- [ ] Procurement Vendor and Approved Vendor List Management output generated per requirements
...
- [ ] Procurement Vendor and Approved Vendor List Management completed successfully
