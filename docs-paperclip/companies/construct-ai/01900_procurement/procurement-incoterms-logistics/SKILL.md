---
title: Procurement Incoterms and Logistics Coordination
description: Manage incoterms compliance, coordinate shipping and logistics, track import/export documentation, and manage customs clearance
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-incoterms-logistics
gigabrain_tags: disciplines, 01900_procurement, procurement-incoterms-logistics, procurement
...
# Procurement Incoterms and Logistics Coordination

## Overview
Manage incoterms compliance, coordinate shipping and logistics, track import/export documentation, and manage customs clearance

**Announce at start:** "I'm using the procurement-incoterms-logistics skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Manage incoterms compliance, coordinate shipping and logistics, track import/export documentation, and manage customs clearance task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage incoterms compliance, coordinate shipping and logistics, track import/export documentation, and manage customs clearance
...
- [ ] Procurement Incoterms and Logistics Coordination output generated per requirements
...
- [ ] Procurement Incoterms and Logistics Coordination completed successfully
