---
title: Procurement Emergency and Expedited Procurement
description: Manage emergency procurement processes including sole source justification, expedited approval routing, and retrospective documentation
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-emergency-procurement
gigabrain_tags: disciplines, 01900_procurement, procurement-emergency-procurement, procurement
openstinger_context: 01900_procurement_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/01900_procurement/agent-data/domain-knowledge/01900_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/01900_procurement/agent-data/domain-knowledge/01900_GLOSSARY.MD
  - docs_construct_ai/disciplines/01900_procurement/agent-data/prompts/01900_AI-NATIVE-PROCUREMENT-PROMPT.md
---

# Procurement Emergency and Expedited Procurement

## Overview
Manage emergency procurement processes including sole source justification, expedited approval routing, and retrospective documentation

**Announce at start:** "I'm using the procurement-emergency-procurement skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Manage emergency procurement processes including sole source justification, expedited approval routing, and retrospective documentation task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage emergency procurement processes including sole source justification, expedited approval routing, and retrospective documentation
...
- [ ] Procurement Emergency and Expedited Procurement output generated per requirements
...
- [ ] Procurement Emergency and Expedited Procurement completed successfully
