...
description: Manage purchase orders, work orders, and service orders from creation through close-out including issuance, tracking, amendment, and confirmation
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-order-management
gigabrain_tags: disciplines, 01900_procurement, procurement-order-management, procurement
...
## Overview
Manage purchase orders, work orders, and service orders from creation through close-out including issuance, tracking, amendment, and confirmation

**Announce at start:** "I'm using the procurement-order-management skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Manage purchase orders, work orders, and service orders from creation through close-out including issuance, tracking, amendment, and confirmation task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage purchase orders, work orders, and service orders from creation through close-out including issuance, tracking, amendment, and confirmation
...
- [ ] Procurement Order Management output generated per requirements
...
- [ ] Procurement Order Management completed successfully
