---
title: Procurement 3-Way Match and Invoice Processing
description: Conduct 3-way matching of PO, goods receipt, and invoice; resolve discrepancies; route for payment processing
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01900_procurement/procurement-invoice-matching
gigabrain_tags: disciplines, 01900_procurement, procurement-invoice-matching, procurement
...
# Procurement 3-Way Match and Invoice Processing

## Overview
Conduct 3-way matching of PO, goods receipt, and invoice; resolve discrepancies; route for payment processing

**Announce at start:** "I'm using the procurement-invoice-matching skill for Procurement operations."

## When to Use This Skill
**Trigger Conditions:** Conduct 3-way matching of PO, goods receipt, and invoice; resolve discrepancies; route for payment processing task required, procurement team task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for conduct 3-way matching of po, goods receipt, and invoice; resolve discrepancies; route for payment processing
...
- [ ] Procurement 3-Way Match and Invoice Processing output generated per requirements
...
- [ ] Procurement 3-Way Match and Invoice Processing completed successfully
