---
title: Logistics Customs and Import/Export Management
description: Manage customs clearance, coordinate import/export documentation, ensure compliance with trade regulations
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01700_logistics/log-customs-import-export
gigabrain_tags: disciplines, 01700_logistics, log-customs-import-export, logistics
openstinger_context: 01700_logistics_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/01700_logistics/agent-data/domain-knowledge/01700_DOMAIN-KNOWLEDGE.MD
---

# Logistics Customs and Import/Export Management

## Overview
Manage customs clearance, coordinate import/export documentation, ensure compliance with trade regulations

**Announce at start:** "I'm using the log-customs-import-export skill for Logistics operations."

## When to Use This Skill
**Trigger Conditions:** Manage customs clearance, coordinate import/export documentation, ensure compliance with trade regulations task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Logistics domain knowledge)
...
1. Identify the specific logistics task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage customs clearance, coordinate import/export documentation, ensure compliance with trade regulations
...
4. Update logistics records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Logistics Customs and Import/Export Management output generated per requirements
...
- [ ] Logistics Customs and Import/Export Management completed successfully
...
### Related Skills
- Additional logistics skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Logistics Manager — Main execution
- **Supporting:** Logistics Administrator — Document and data management
- **Oversight:** Logistics Manager — Review, approval, and escalation

### Related Domain Knowledge
- Logistics Domain Knowledge for role responsibilities and frameworks
- Logistics Glossary for terminology, definitions, and abbreviations
