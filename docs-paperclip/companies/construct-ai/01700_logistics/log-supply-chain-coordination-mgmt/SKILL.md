...
description: Coordinate supply chain activities, manage supplier relationships, track material deliveries
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01700_logistics/log-supply-chain-coordination-mgmt
gigabrain_tags: disciplines, 01700_logistics, log-supply-chain-coordination-mgmt, logistics
...
## Overview
Coordinate supply chain activities, manage supplier relationships, track material deliveries

**Announce at start:** "I'm using the log-supply-chain-coordination-mgmt skill for Logistics operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate supply chain activities, manage supplier relationships, track material deliveries task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate supply chain activities, manage supplier relationships, track material deliveries
...
- [ ] Logistics Supply Chain Coordination output generated per requirements
...
- [ ] Logistics Supply Chain Coordination completed successfully
