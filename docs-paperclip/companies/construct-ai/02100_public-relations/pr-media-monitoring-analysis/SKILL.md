---
title: PR Media Monitoring and Analysis
description: Monitor media coverage, analyze sentiment, identify key issues, compile media reports
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02100_public-relations/pr-media-monitoring-analysis
gigabrain_tags: disciplines, 02100_public-relations, pr-media-monitoring-analysis, public-relations
...
# PR Media Monitoring and Analysis

## Overview
Monitor media coverage, analyze sentiment, identify key issues, compile media reports

**Announce at start:** "I'm using the pr-media-monitoring-analysis skill for Public Relations operations."

## When to Use This Skill
**Trigger Conditions:** Monitor media coverage, analyze sentiment, identify key issues, compile media reports task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor media coverage, analyze sentiment, identify key issues, compile media reports
...
- [ ] PR Media Monitoring and Analysis output generated per requirements
...
- [ ] PR Media Monitoring and Analysis completed successfully
