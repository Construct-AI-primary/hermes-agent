---
title: PR Stakeholder Communications Management
description: Manage stakeholder communications, coordinate community engagement, handle public inquiries
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02100_public-relations/pr-stakeholder-communications
gigabrain_tags: disciplines, 02100_public-relations, pr-stakeholder-communications, public-relations
...
# PR Stakeholder Communications Management

## Overview
Manage stakeholder communications, coordinate community engagement, handle public inquiries

**Announce at start:** "I'm using the pr-stakeholder-communications skill for Public Relations operations."

## When to Use This Skill
**Trigger Conditions:** Manage stakeholder communications, coordinate community engagement, handle public inquiries task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage stakeholder communications, coordinate community engagement, handle public inquiries
...
- [ ] PR Stakeholder Communications Management output generated per requirements
...
- [ ] PR Stakeholder Communications Management completed successfully
...
### Related Agents
- **Primary:** PR Manager — Main execution
