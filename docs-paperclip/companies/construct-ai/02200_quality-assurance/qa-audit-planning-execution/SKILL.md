---
title: QA Audit Planning and Execution
description: Plan and execute QA audits, develop audit checklists, document findings, compile audit reports
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02200_quality-assurance/qa-audit-planning-execution
gigabrain_tags: disciplines, 02200_quality-assurance, qa-audit-planning-execution, quality-assurance
...
# QA Audit Planning and Execution

## Overview
Plan and execute QA audits, develop audit checklists, document findings, compile audit reports

**Announce at start:** "I'm using the qa-audit-planning-execution skill for Quality Assurance operations."

## When to Use This Skill
**Trigger Conditions:** Plan and execute QA audits, develop audit checklists, document findings, compile audit reports task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for plan and execute qa audits, develop audit checklists, document findings, compile audit reports
...
- [ ] QA Audit Planning and Execution output generated per requirements
...
- [ ] QA Audit Planning and Execution completed successfully
