---
title: Contract Close-Out Management
description: Manage contract close-out including final accounts, release certificates, and lessons learned
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00435_contracts-post-award/contract-close-out-Management
gigabrain_tags: disciplines, 00435_contracts-post-award, contract-close-out-Management, contracts-post-award
...
# Contract Close-Out Management

## Overview
Manage contract close-out including final accounts, release certificates, and lessons learned

**Announce at start:** "I'm using the contract-close-out-Management skill for Contracts Post-Award operations."

## When to Use This Skill
**Trigger Conditions:** Manage contract close-out including final accounts, release certificates, and lessons learned task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage contract close-out including final accounts, release certificates, and lessons learned
...
- [ ] Contract Close-Out Management output generated per requirements
...
- [ ] Contract Close-Out Management completed successfully
