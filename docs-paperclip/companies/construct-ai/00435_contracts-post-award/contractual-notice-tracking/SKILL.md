---
title: Contractual Notice Tracking
description: Track all contractual notices, time bars, and conditions precedent to preserve rights
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00435_contracts-post-award/contractual-notice-tracking
gigabrain_tags: disciplines, 00435_contracts-post-award, contractual-notice-tracking, contracts-post-award
...
## Overview
Track all contractual notices, time bars, and conditions precedent to preserve rights

**Announce at start:** "I'm using the contractual-notice-tracking skill for Contracts Post-Award operations."

## When to Use This Skill
**Trigger Conditions:** Track all contractual notices, time bars, and conditions precedent to preserve rights task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for track all contractual notices, time bars, and conditions precedent to preserve rights
...
- [ ] Contractual Notice Tracking output generated per requirements
...
- [ ] Contractual Notice Tracking completed successfully
