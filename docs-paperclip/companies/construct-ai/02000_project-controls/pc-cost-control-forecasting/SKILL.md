---
title: Project Controls Cost Control and Forecasting
description: Monitor project costs, forecast budget at completion, identify variances, recommend corrective actions
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02000_project-controls/pc-cost-control-forecasting
gigabrain_tags: disciplines, 02000_project-controls, pc-cost-control-forecasting, project-controls
...
# Project Controls Cost Control and Forecasting

## Overview
Monitor project costs, forecast budget at completion, identify variances, recommend corrective actions

**Announce at start:** "I'm using the pc-cost-control-forecasting skill for Project Controls operations."

## When to Use This Skill
**Trigger Conditions:** Monitor project costs, forecast budget at completion, identify variances, recommend corrective actions task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor project costs, forecast budget at completion, identify variances, recommend corrective actions
...
- [ ] Project Controls Cost Control and Forecasting output generated per requirements
...
- [ ] Project Controls Cost Control and Forecasting completed successfully
...
### Related Agents
- **Primary:** Cost Engineer — Main execution
