---
title: Health Wellness Program Management
description: Manage employee wellness programs including health education, fitness programs, and mental health support
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01400_health/health-wellness-program-mgmt
gigabrain_tags: disciplines, 01400_health, health-wellness-program-mgmt, health
...
## Overview
Manage employee wellness programs including health education, fitness programs, and mental health support

**Announce at start:** "I'm using the health-wellness-program-mgmt skill for Health operations."

## When to Use This Skill
**Trigger Conditions:** Manage employee wellness programs including health education, fitness programs, and mental health support task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage employee wellness programs including health education, fitness programs, and mental health support
...
- [ ] Health Wellness Program Management output generated per requirements
...
- [ ] Health Wellness Program Management completed successfully
