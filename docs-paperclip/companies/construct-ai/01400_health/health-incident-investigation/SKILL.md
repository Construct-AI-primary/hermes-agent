---
title: Health Incident Investigation and Follow-Up
description: Investigate health incidents, identify root causes, recommend controls, track corrective actions
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01400_health/health-incident-investigation
gigabrain_tags: disciplines, 01400_health, health-incident-investigation, health
...
# Health Incident Investigation and Follow-Up

## Overview
Investigate health incidents, identify root causes, recommend controls, track corrective actions

**Announce at start:** "I'm using the health-incident-investigation skill for Health operations."

## When to Use This Skill
**Trigger Conditions:** Investigate health incidents, identify root causes, recommend controls, track corrective actions task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for investigate health incidents, identify root causes, recommend controls, track corrective actions
...
- [ ] Health Incident Investigation and Follow-Up output generated per requirements
...
- [ ] Health Incident Investigation and Follow-Up completed successfully
