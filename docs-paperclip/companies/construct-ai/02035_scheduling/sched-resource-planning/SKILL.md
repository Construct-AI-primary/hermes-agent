---
title: Scheduling Sched Resource Planning
description: Resource loaded scheduling
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02035_scheduling/sched-resource-planning
gigabrain_tags: disciplines, 02035_scheduling, sched-resource-planning, scheduling
openstinger_context: scheduling, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/02035_scheduling/agent-data/domain-knowledge/02035_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/02035_scheduling/agent-data/prompts/02035_AI-NATIVE-SCHEDULING-PROMPT.md
---

# Scheduling Sched Resource Planning

## Overview
Resource loaded scheduling
**Announce at start:** "I'm using the sched-resource-planning skill for Scheduling operations."

## When to Use This Skill
**Trigger Conditions:** Resource loaded scheduling task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the scheduling task or request
...
### Step 3: Execution
1. Apply discipline-specific sched resource planning methods
...
3. Update scheduling records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Sched Resource Planning output generated
...
### Related Agents
- Scheduling Coordinator — Primary agent
- Scheduling Manager — Oversight agent
