---
title: Mechanical-Eng Mech Hvac Design
description: HVAC load calculation and equipment selection
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00870_mechanical-engineering/mech-hvac-design
gigabrain_tags: disciplines, 00870_mechanical-engineering, mech-hvac-design, mechanical-eng
...
# Mechanical-Eng Mech Hvac Design

## Overview
HVAC load calculation and equipment selection
**Announce at start:** "I'm using the mech-hvac-design skill for Mechanical Eng operations."

## When to Use This Skill
**Trigger Conditions:** HVAC load calculation and equipment selection task required
...
### Step 3: Execution
1. Apply discipline-specific mech hvac design methods
...
- [ ] Mech Hvac Design output generated
