---
title: Design BIM Coordination and Clash Detection
description: Coordinate BIM models, run clash detection, assign resolution, track outcomes
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00800_design/design-bim-coordination-clash
gigabrain_tags: disciplines, 00800_design, design-bim-coordination-clash, design
...
# Design BIM Coordination and Clash Detection

## Overview
Coordinate BIM models, run clash detection, assign resolution, track outcomes

**Announce at start:** "I'm using the design-bim-coordination-clash skill for Design operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate BIM models, run clash detection, assign resolution, track outcomes task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate bim models, run clash detection, assign resolution, track outcomes
...
- [ ] Design BIM Coordination and Clash Detection output generated per requirements
...
- [ ] Design BIM Coordination and Clash Detection completed successfully
