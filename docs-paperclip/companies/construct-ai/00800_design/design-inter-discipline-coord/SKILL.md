---
title: Design Inter-Discipline Coordination
description: Coordinate design interfaces, resolve conflicts, issue interface documents between disciplines
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00800_design/design-inter-discipline-coord
gigabrain_tags: disciplines, 00800_design, design-inter-discipline-coord, design
...
# Design Inter-Discipline Coordination

## Overview
Coordinate design interfaces, resolve conflicts, issue interface documents between disciplines

**Announce at start:** "I'm using the design-inter-discipline-coord skill for Design operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate design interfaces, resolve conflicts, issue interface documents between disciplines task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate design interfaces, resolve conflicts, issue interface documents between disciplines
...
- [ ] Design Inter-Discipline Coordination output generated per requirements
...
- [ ] Design Inter-Discipline Coordination completed successfully
...
### Related Agents
- **Primary:** Design Manager — Main execution
