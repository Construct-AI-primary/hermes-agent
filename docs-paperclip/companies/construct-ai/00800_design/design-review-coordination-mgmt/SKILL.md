---
title: Design Review Coordination Management
description: Coordinate multi-disciplinary design reviews, compile comments, track actions to resolution
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00800_design/design-review-coordination-mgmt
gigabrain_tags: disciplines, 00800_design, design-review-coordination-mgmt, design
...
# Design Review Coordination Management

## Overview
Coordinate multi-disciplinary design reviews, compile comments, track actions to resolution

**Announce at start:** "I'm using the design-review-coordination-mgmt skill for Design operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate multi-disciplinary design reviews, compile comments, track actions to resolution task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate multi-disciplinary design reviews, compile comments, track actions to resolution
...
- [ ] Design Review Coordination Management output generated per requirements
...
- [ ] Design Review Coordination Management completed successfully
