---
title: QC Material Testing and Acceptance Coordination
description: Coordinate material testing, verify test results, manage non-conforming materials
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02250_quality-control/qc-material-testing-coordination
gigabrain_tags: disciplines, 02250_quality-control, qc-material-testing-coordination, quality-control
...
# QC Material Testing and Acceptance Coordination

## Overview
Coordinate material testing, verify test results, manage non-conforming materials

**Announce at start:** "I'm using the qc-material-testing-coordination skill for Quality Control operations."

## When to Use This Skill
**Trigger Conditions:** Coordinate material testing, verify test results, manage non-conforming materials task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for coordinate material testing, verify test results, manage non-conforming materials
...
- [ ] QC Material Testing and Acceptance Coordination output generated per requirements
...
- [ ] QC Material Testing and Acceptance Coordination completed successfully
...
### Related Agents
- **Primary:** QC Manager — Main execution
