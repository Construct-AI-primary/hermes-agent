---
title: QC Defect Tracking and Resolution Management
description: Track defects through identification, assessment, rectification, and verification to closure
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/02250_quality-control/qc-defect-tracking-resolution
gigabrain_tags: disciplines, 02250_quality-control, qc-defect-tracking-resolution, quality-control
openstinger_context: 02250_quality_control_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/02250_quality-control/agent-data/domain-knowledge/02250_DOMAIN-KNOWLEDGE.MD
---

# QC Defect Tracking and Resolution Management

## Overview
Track defects through identification, assessment, rectification, and verification to closure

**Announce at start:** "I'm using the qc-defect-tracking-resolution skill for Quality Control operations."

## When to Use This Skill
**Trigger Conditions:** Track defects through identification, assessment, rectification, and verification to closure task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Quality Control domain knowledge)
...
1. Identify the specific quality control task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for track defects through identification, assessment, rectification, and verification to closure
...
4. Update quality control records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] QC Defect Tracking and Resolution Management output generated per requirements
...
- [ ] QC Defect Tracking and Resolution Management completed successfully
...
### Related Skills
- Additional quality control skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** QC Inspector — Main execution
- **Supporting:** Quality Control Administrator — Document and data management
- **Oversight:** Quality Control Manager — Review, approval, and escalation

### Related Domain Knowledge
- Quality Control Domain Knowledge for role responsibilities and frameworks
- Quality Control Glossary for terminology, definitions, and abbreviations
