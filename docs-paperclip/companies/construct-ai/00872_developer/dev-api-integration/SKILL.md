---
title: Developer Dev Api Integration
description: API integration and testing
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00872_developer/dev-api-integration
gigabrain_tags: disciplines, 00872_developer, dev-api-integration, developer
openstinger_context: developer, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/00872_developer/agent-data/domain-knowledge/00872_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/00872_developer/agent-data/prompts/00872_AI-NATIVE-DEVELOPER-PROMPT.md
---

# Developer Dev Api Integration

## Overview
API integration and testing
**Announce at start:** "I'm using the dev-api-integration skill for Developer operations."

## When to Use This Skill
**Trigger Conditions:** API integration and testing task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the developer task or request
...
### Step 3: Execution
1. Apply discipline-specific dev api integration methods
...
3. Update developer records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Dev Api Integration output generated
...
### Related Agents
- Developer Coordinator — Primary agent
- Developer Manager — Oversight agent
