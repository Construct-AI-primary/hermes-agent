---
title: Developer Dev Cicd Pipeline
description: CI/CD pipeline management
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00872_developer/dev-cicd-pipeline
gigabrain_tags: disciplines, 00872_developer, dev-cicd-pipeline, developer
...
# Developer Dev Cicd Pipeline

## Overview
CI/CD pipeline management
**Announce at start:** "I'm using the dev-cicd-pipeline skill for Developer operations."

## When to Use This Skill
**Trigger Conditions:** CI/CD pipeline management task required
...
### Step 3: Execution
1. Apply discipline-specific dev cicd pipeline methods
...
- [ ] Dev Cicd Pipeline output generated
