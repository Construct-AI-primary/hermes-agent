---
title: Developer Dev Code Review
description: Code review and quality gates
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00872_developer/dev-code-review
gigabrain_tags: disciplines, 00872_developer, dev-code-review, developer
...
# Developer Dev Code Review

## Overview
Code review and quality gates
**Announce at start:** "I'm using the dev-code-review skill for Developer operations."

## When to Use This Skill
**Trigger Conditions:** Code review and quality gates task required
...
### Step 3: Execution
1. Apply discipline-specific dev code review methods
...
- [ ] Dev Code Review output generated
