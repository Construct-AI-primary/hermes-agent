---
title: Process-Eng Process Equipment Spec
description: Equipment specification and datasheets
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00871_process-engineering/process-equipment-spec
gigabrain_tags: disciplines, 00871_process-engineering, process-equipment-spec, process-eng
...
# Process-Eng Process Equipment Spec

## Overview
Equipment specification and datasheets
**Announce at start:** "I'm using the process-equipment-spec skill for Process Eng operations."

## When to Use This Skill
**Trigger Conditions:** Equipment specification and datasheets task required
...
### Step 3: Execution
1. Apply discipline-specific process equipment spec methods
...
- [ ] Process Equipment Spec output generated
