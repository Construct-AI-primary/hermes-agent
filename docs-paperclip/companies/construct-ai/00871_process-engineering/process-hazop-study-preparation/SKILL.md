---
title: Process HAZOP Study Preparation and Support
description: Prepare for HAZOP studies, develop nodes, assist facilitation, track recommendations
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00871_process-engineering/process-hazop-study-preparation
gigabrain_tags: disciplines, 00871_process-engineering, process-hazop-study-preparation, process-engineering
...
# Process HAZOP Study Preparation and Support

## Overview
Prepare for HAZOP studies, develop nodes, assist facilitation, track recommendations

**Announce at start:** "I'm using the process-hazop-study-preparation skill for Process Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Prepare for HAZOP studies, develop nodes, assist facilitation, track recommendations task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for prepare for hazop studies, develop nodes, assist facilitation, track recommendations
...
- [ ] Process HAZOP Study Preparation and Support output generated per requirements
...
- [ ] Process HAZOP Study Preparation and Support completed successfully
...
### Related Agents
- **Primary:** Process Safety Analyst — Main execution
