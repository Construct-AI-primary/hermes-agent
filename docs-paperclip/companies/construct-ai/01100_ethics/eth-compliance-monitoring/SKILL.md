---
title: Ethics Eth Compliance Monitoring
description: Ethics compliance tracking
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01100_ethics/eth-compliance-monitoring
gigabrain_tags: disciplines, 01100_ethics, eth-compliance-monitoring, ethics
openstinger_context: ethics, skill-execution
last_updated: 2026-04-01
related_docs:
  - docs_construct_ai/disciplines/01100_ethics/agent-data/domain-knowledge/01100_DOMAIN-KNOWLEDGE.MD
  - docs_construct_ai/disciplines/01100_ethics/agent-data/prompts/01100_AI-NATIVE-ETHICS-PROMPT.md
---

# Ethics Eth Compliance Monitoring

## Overview
Ethics compliance tracking
**Announce at start:** "I'm using the eth-compliance-monitoring skill for Ethics operations."

## When to Use This Skill
**Trigger Conditions:** Ethics compliance tracking task required
**Prerequisites:** Domain knowledge available, appropriate permissions

## Step-by-Step Procedure
### Step 1: Initiation
1. Identify the ethics task or request
...
### Step 3: Execution
1. Apply discipline-specific eth compliance monitoring methods
...
3. Update ethics records

## Success Criteria
- [ ] Task scope clearly defined
- [ ] Required inputs gathered
- [ ] Eth Compliance Monitoring output generated
...
## Cross-References
### Related Skills
- Additional ethics skills
### Related Agents
- Ethics Coordinator — Primary agent
- Ethics Manager — Oversight agent
