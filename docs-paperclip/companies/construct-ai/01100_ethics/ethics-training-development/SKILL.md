---
title: Ethics Training and Awareness Development
description: Develop ethics training programs, conduct awareness campaigns, measure effectiveness
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01100_ethics/ethics-training-development
gigabrain_tags: disciplines, 01100_ethics, ethics-training-development, ethics
...
# Ethics Training and Awareness Development

## Overview
Develop ethics training programs, conduct awareness campaigns, measure effectiveness

**Announce at start:** "I'm using the ethics-training-development skill for Ethics operations."

## When to Use This Skill
**Trigger Conditions:** Develop ethics training programs, conduct awareness campaigns, measure effectiveness task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for develop ethics training programs, conduct awareness campaigns, measure effectiveness
...
- [ ] Ethics Training and Awareness Development output generated per requirements
...
- [ ] Ethics Training and Awareness Development completed successfully
