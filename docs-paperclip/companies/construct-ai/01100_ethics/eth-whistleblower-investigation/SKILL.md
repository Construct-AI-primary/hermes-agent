---
title: Ethics Whistleblower Investigation Management
description: Investigate whistleblower reports, conduct fair investigations, recommend actions, protect whistleblowers
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01100_ethics/eth-whistleblower-investigation
gigabrain_tags: disciplines, 01100_ethics, eth-whistleblower-investigation, ethics
openstinger_context: 01100_ethics_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/01100_ethics/agent-data/domain-knowledge/01100_DOMAIN-KNOWLEDGE.MD
---

# Ethics Whistleblower Investigation Management

## Overview
Investigate whistleblower reports, conduct fair investigations, recommend actions, protect whistleblowers

**Announce at start:** "I'm using the eth-whistleblower-investigation skill for Ethics operations."

## When to Use This Skill
**Trigger Conditions:** Investigate whistleblower reports, conduct fair investigations, recommend actions, protect whistleblowers task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Ethics domain knowledge)
...
1. Identify the specific ethics task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for investigate whistleblower reports, conduct fair investigations, recommend actions, protect whistleblowers
...
4. Update ethics records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Ethics Whistleblower Investigation Management output generated per requirements
...
- [ ] Ethics Whistleblower Investigation Management completed successfully
...
### Related Skills
- Additional ethics skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Compliance Analyst — Main execution
- **Supporting:** Ethics Administrator — Document and data management
- **Oversight:** Ethics Manager — Review, approval, and escalation

### Related Domain Knowledge
- Ethics Domain Knowledge for role responsibilities and frameworks
- Ethics Glossary for terminology, definitions, and abbreviations
