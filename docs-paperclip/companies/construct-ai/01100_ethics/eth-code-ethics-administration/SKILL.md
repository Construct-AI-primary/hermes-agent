---
title: Ethics Code of Ethics Administration
description: Administer code of ethics, conduct training, monitor compliance, handle violations
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01100_ethics/eth-code-ethics-administration
gigabrain_tags: disciplines, 01100_ethics, eth-code-ethics-administration, ethics
...
# Ethics Code of Ethics Administration

## Overview
Administer code of ethics, conduct training, monitor compliance, handle violations

**Announce at start:** "I'm using the eth-code-ethics-administration skill for Ethics operations."

## When to Use This Skill
**Trigger Conditions:** Administer code of ethics, conduct training, monitor compliance, handle violations task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for administer code of ethics, conduct training, monitor compliance, handle violations
...
- [ ] Ethics Code of Ethics Administration output generated per requirements
...
- [ ] Ethics Code of Ethics Administration completed successfully
