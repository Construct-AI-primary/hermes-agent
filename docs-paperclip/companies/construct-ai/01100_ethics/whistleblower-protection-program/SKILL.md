---
title: Whistleblower Protection Program Management
description: Manage whistleblower protection program, ensure non-retaliation, track protection measures
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/01100_ethics/whistleblower-protection-program
gigabrain_tags: disciplines, 01100_ethics, whistleblower-protection-program, ethics
...
# Whistleblower Protection Program Management

## Overview
Manage whistleblower protection program, ensure non-retaliation, track protection measures

**Announce at start:** "I'm using the whistleblower-protection-program skill for Ethics operations."

## When to Use This Skill
**Trigger Conditions:** Manage whistleblower protection program, ensure non-retaliation, track protection measures task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage whistleblower protection program, ensure non-retaliation, track protection measures
...
- [ ] Whistleblower Protection Program Management output generated per requirements
...
- [ ] Whistleblower Protection Program Management completed successfully
...
### Related Agents
- **Primary:** Ethics Officer — Main execution
