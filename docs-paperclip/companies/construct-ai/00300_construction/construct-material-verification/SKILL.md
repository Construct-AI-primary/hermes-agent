---
title: Construction Material Verification
description: Verify delivered materials match specifications, check certifications, manage non-conforming materials
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-material-verification
gigabrain_tags: disciplines, 00300_construction, construct-material-verification, construction
...
# Construction Material Verification

## Overview
Verify delivered materials match specifications, check certifications, manage non-conforming materials

**Announce at start:** "I'm using the construct-material-verification skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Verify delivered materials match specifications, check certifications, manage non-conforming materials task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for verify delivered materials match specifications, check certifications, manage non-conforming materials
...
- [ ] Construction Material Verification output generated per requirements
...
- [ ] Construction Material Verification completed successfully
