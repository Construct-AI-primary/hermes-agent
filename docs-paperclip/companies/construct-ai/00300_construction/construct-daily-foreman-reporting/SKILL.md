---
title: Construction Daily Foreman Reporting
description: Compile daily foreman reports including manpower, plant, weather, progress, incidents, and look-ahead
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-daily-foreman-reporting
gigabrain_tags: disciplines, 00300_construction, construct-daily-foreman-reporting, construction
...
# Construction Daily Foreman Reporting

## Overview
Compile daily foreman reports including manpower, plant, weather, progress, incidents, and look-ahead

**Announce at start:** "I'm using the construct-daily-foreman-reporting skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Compile daily foreman reports including manpower, plant, weather, progress, incidents, and look-ahead task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for compile daily foreman reports including manpower, plant, weather, progress, incidents, and look-ahead
...
- [ ] Construction Daily Foreman Reporting output generated per requirements
...
- [ ] Construction Daily Foreman Reporting completed successfully
...
### Related Agents
- **Primary:** General Foreman — Main execution
