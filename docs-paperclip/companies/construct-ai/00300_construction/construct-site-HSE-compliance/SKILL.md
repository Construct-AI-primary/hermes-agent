---
title: Construction Site HSE Compliance
description: Monitor site HSE compliance, identify hazards, ensure PPE usage, conduct safety briefings
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-site-HSE-compliance
gigabrain_tags: disciplines, 00300_construction, construct-site-HSE-compliance, construction
...
# Construction Site HSE Compliance

## Overview
Monitor site HSE compliance, identify hazards, ensure PPE usage, conduct safety briefings

**Announce at start:** "I'm using the construct-site-HSE-compliance skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Monitor site HSE compliance, identify hazards, ensure PPE usage, conduct safety briefings task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for monitor site hse compliance, identify hazards, ensure ppe usage, conduct safety briefings
...
- [ ] Construction Site HSE Compliance output generated per requirements
...
- [ ] Construction Site HSE Compliance completed successfully
