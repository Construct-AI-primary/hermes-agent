---
title: Construction RFI Management
description: Process RFIs from site, coordinate with design team, distribute responses, track outstanding RFIs
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00300_construction/construct-RFI-management
gigabrain_tags: disciplines, 00300_construction, construct-RFI-management, construction
...
## Overview
Process RFIs from site, coordinate with design team, distribute responses, track outstanding RFIs

**Announce at start:** "I'm using the construct-RFI-management skill for Construction operations."

## When to Use This Skill
**Trigger Conditions:** Process RFIs from site, coordinate with design team, distribute responses, track outstanding RFIs task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for process rfis from site, coordinate with design team, distribute responses, track outstanding rfis
...
- [ ] Construction RFI Management output generated per requirements
...
- [ ] Construction RFI Management completed successfully
