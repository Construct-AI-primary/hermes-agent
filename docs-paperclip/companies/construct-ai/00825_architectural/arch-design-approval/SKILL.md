---
title: Architectural Arch Design Approval
description: Design approval workflow
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-design-approval
gigabrain_tags: disciplines, 00825_architectural, arch-design-approval, architectural
...
# Architectural Arch Design Approval

## Overview
Design approval workflow
**Announce at start:** "I'm using the arch-design-approval skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** Design approval workflow task required
...
### Step 3: Execution
1. Apply discipline-specific arch design approval methods
...
- [ ] Arch Design Approval output generated
