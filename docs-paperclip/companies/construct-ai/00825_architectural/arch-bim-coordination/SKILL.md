---
title: Architectural Arch Bim Coordination
description: BIM model coordination and clash detection
version: 1.0
frequency_percent: 70.0
success_rate_percent: 85.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-bim-coordination
gigabrain_tags: disciplines, 00825_architectural, arch-bim-coordination, architectural
...
# Architectural Arch Bim Coordination

## Overview
BIM model coordination and clash detection
**Announce at start:** "I'm using the arch-bim-coordination skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** BIM model coordination and clash detection task required
...
### Step 3: Execution
1. Apply discipline-specific arch bim coordination methods
...
- [ ] Arch Bim Coordination output generated
