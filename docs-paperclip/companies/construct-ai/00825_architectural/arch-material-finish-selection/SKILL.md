---
title: Architectural Material and Finish Selection
description: Select and specify materials and finishes considering aesthetics, durability, cost, and compliance
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00825_architectural/arch-material-finish-selection
gigabrain_tags: disciplines, 00825_architectural, arch-material-finish-selection, architectural
...
# Architectural Material and Finish Selection

## Overview
Select and specify materials and finishes considering aesthetics, durability, cost, and compliance

**Announce at start:** "I'm using the arch-material-finish-selection skill for Architectural operations."

## When to Use This Skill
**Trigger Conditions:** Select and specify materials and finishes considering aesthetics, durability, cost, and compliance task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for select and specify materials and finishes considering aesthetics, durability, cost, and compliance
...
- [ ] Architectural Material and Finish Selection output generated per requirements
...
- [ ] Architectural Material and Finish Selection completed successfully
