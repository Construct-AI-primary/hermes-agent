---
title: Sales Client Relationship Management
description: Manage client relationships, track touchpoints, identify opportunities, escalate concerns
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00875_sales/sales-client-relationship-account
gigabrain_tags: disciplines, 00875_sales, sales-client-relationship-account, sales
...
## Overview
Manage client relationships, track touchpoints, identify opportunities, escalate concerns

**Announce at start:** "I'm using the sales-client-relationship-account skill for Sales operations."

## When to Use This Skill
**Trigger Conditions:** Manage client relationships, track touchpoints, identify opportunities, escalate concerns task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for manage client relationships, track touchpoints, identify opportunities, escalate concerns
...
- [ ] Sales Client Relationship Management output generated per requirements
...
- [ ] Sales Client Relationship Management completed successfully
