---
title: Geotechnical Foundation Recommendation and Design
description: Recommend foundation types, design shallow/deep foundations, assess bearing capacity and settlement
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00855_geotechnical-engineering/geotech-foundation-research
gigabrain_tags: disciplines, 00855_geotechnical-engineering, geotech-foundation-research, geotechnical-engineering
openstinger_context: 00855_geotechnical_engineering_operations, skill-execution
last_updated: 2026-04-02
related_docs:
  - docs_construct_ai/disciplines/00855_geotechnical-engineering/agent-data/domain-knowledge/00855_DOMAIN-KNOWLEDGE.MD
---

# Geotechnical Foundation Recommendation and Design

## Overview
Recommend foundation types, design shallow/deep foundations, assess bearing capacity and settlement

**Announce at start:** "I'm using the geotech-foundation-research skill for Geotechnical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Recommend foundation types, design shallow/deep foundations, assess bearing capacity and settlement task required, discipline-specific task or request received
**Prerequisites:**
- Domain knowledge available (Geotechnical Engineering domain knowledge)
...
1. Identify the specific geotechnical engineering task triggering this skill
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for recommend foundation types, design shallow/deep foundations, assess bearing capacity and settlement
...
4. Update geotechnical engineering records, logs, and registers

## Success Criteria
- [ ] Task scope clearly defined and authorized
- [ ] All required inputs gathered and validated
- [ ] Geotechnical Foundation Recommendation and Design output generated per requirements
...
- [ ] Geotechnical Foundation Recommendation and Design completed successfully
...
### Related Skills
- Additional geotechnical engineering skills for related functions
- Skills from interfacing disciplines for cross-functional tasks

### Related Agents
- **Primary:** Geotechnical Engineer — Main execution
- **Supporting:** Geotechnical Engineering Administrator — Document and data management
- **Oversight:** Geotechnical Engineering Manager — Review, approval, and escalation

### Related Domain Knowledge
- Geotechnical Engineering Domain Knowledge for role responsibilities and frameworks
- Geotechnical Engineering Glossary for terminology, definitions, and abbreviations
