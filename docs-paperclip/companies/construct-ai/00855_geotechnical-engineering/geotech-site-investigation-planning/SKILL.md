---
title: Geotechnical Site Investigation Planning
description: Plan site investigation campaigns, specify drilling/testing requirements, supervise field work
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00855_geotechnical-engineering/geotech-site-investigation-planning
gigabrain_tags: disciplines, 00855_geotechnical-engineering, geotech-site-investigation-planning, geotechnical-engineering
...
## Overview
Plan site investigation campaigns, specify drilling/testing requirements, supervise field work

**Announce at start:** "I'm using the geotech-site-investigation-planning skill for Geotechnical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Plan site investigation campaigns, specify drilling/testing requirements, supervise field work task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for plan site investigation campaigns, specify drilling/testing requirements, supervise field work
...
- [ ] Geotechnical Site Investigation Planning output generated per requirements
...
- [ ] Geotechnical Site Investigation Planning completed successfully
...
### Related Agents
- **Primary:** Geotechnical Manager — Main execution
