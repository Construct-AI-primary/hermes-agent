...
description: Perform slope stability analysis, recommend stabilization measures, design retaining structures
version: 1.0
frequency_percent: 60.0
success_rate_percent: 87.0
memory_layer: durable_knowledge
para_section: docs_construct_ai/skills/domainforge_ai/00855_geotechnical-engineering/geotech-slope-stability-analysis
gigabrain_tags: disciplines, 00855_geotechnical-engineering, geotech-slope-stability-analysis, geotechnical-engineering
...
## Overview
Perform slope stability analysis, recommend stabilization measures, design retaining structures

**Announce at start:** "I'm using the geotech-slope-stability-analysis skill for Geotechnical Engineering operations."

## When to Use This Skill
**Trigger Conditions:** Perform slope stability analysis, recommend stabilization measures, design retaining structures task required, discipline-specific task or request received
**Prerequisites:**
...
### Step 3: Execution
1. Apply discipline-specific methods and tools for perform slope stability analysis, recommend stabilization measures, design retaining structures
...
- [ ] Geotechnical Slope Stability Analysis output generated per requirements
...
- [ ] Geotechnical Slope Stability Analysis completed successfully
